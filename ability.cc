...
if (you[0].species != 14 && you[0].mutation [29] > 0) // sense surr
{
 ability [abil_c] = 2;
...
if ((you[0].clas == 8 && you[0].xl > 7) | wearing_amulet(35) != 0)
{
 ability [abil_c] = 11;
...
if (((you[0].equip [7] != -1 && you[0].inv_type [you[0].equip [7]] == 8) | (you[0].equip [8] != -1 && you[0].inv_type [you[0].equip [8]] == 8) | (you[0].equip [4] != -1 && you[0].inv_dam [you[0].equip [4]] == 6)) && you[0].invis == 0)
{
 ability [abil_c] = 51;
 ability_fail [abil_c] = 50 - you[0].xl * 2;
 abil_c ++;
...
if (((you[0].equip [7] != -1 && you[0].inv_type [you[0].equip [7]] == 18) | (you[0].equip [8] != -1 && you[0].inv_type [you[0].equip [8]] == 18) | (you[0].equip [4] != -1 && you[0].inv_dam [you[0].equip [4]] == 11)) && you[0].lev == 0)
{
 ability [abil_c] = 53;
 ability_fail [abil_c] = 50 - you[0].xl * 2;
 abil_c ++;
...
if ((you[0].equip [7] != -1 && you[0].inv_type [you[0].equip [7]] == 10) | (you[0].equip [8] != -1 && you[0].inv_type [you[0].equip [8]] == 10) | you[0].mutation [27] != 0)
{
 ability [abil_c] = 3;
...
*/
query : strcpy(info, "Use which ability?");
mpr(info);
...
case 51:
cprintf("Turn Invisible                  5 Magic, Food");
break;
case 52:
