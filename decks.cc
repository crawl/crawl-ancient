...
static void cards( unsigned char which_card )
{
    ...
    switch ( which_card )
    {
      ...
      case CARD_BUTTERFLY:
        ...
        if ( create_monster(MONS_BUTTERFLY, 21 + random2(4), BEH_CHASING_I, you.x_pos, you.y_pos, MHITYOU, 250) != -1 )
      ...
      case CARD_EXPERIENCE:
        ...
        {
            you.experience = 1 + exp_needed(you.experience_level + 2, you.species);
            level_change();
        }
        break;
...
// I do not like how this works -- what if (you.foo != you.max_foo) ??? {dlb}
    case CARD_SHUFFLE:                    // shuffle stats
        ...
        while (dvar[STAT_STRENGTH] != 101 || dvar[STAT_DEXTERITY] != 101 || dvar[STAT_INTELLIGENCE] != 101);
    ...
    case CARD_DEMON_LESSER:
        ...
        if ( create_monster(MONS_WHITE_IMP + random2(5), 21 + random2(4), BEH_ENSLAVED, you.x_pos, you.y_pos, MHITYOU, 250) != -1 )
    ...
    case CARD_DEMON_COMMON:
        ...
        if ( create_monster(MONS_NEQOXEC + random2(5), 21 + random2(3), BEH_ENSLAVED, you.x_pos, you.y_pos, MHITYOU, 250) != -1 )
          mpr("The picture comes to life!");
        break;
    ...
    case CARD_DEMON_GREATER:
        ...
        if ( create_monster(MONS_NEQOXEC + random2(5), 20 + random2(3), BEH_ENSLAVED, you.x_pos, you.y_pos, MHITYOU, 250) != -1 )
          mpr("The picture comes to life!");
        break;
    ...
    case CARD_DEMON_SWARM:
        ...
        for (loopy = 0; loopy < 7; loopy++)
          if ( create_monster(MONS_WHITE_IMP + random2(5), 21 + random2(4), BEH_CHASING_I, you.x_pos, you.y_pos, MHITYOU, 250) != -1 )
            success = true;
    ...
    case CARD_YAK:
        ...
        if ( create_monster(MONS_DEATH_YAK, 25, BEH_ENSLAVED, you.x_pos, you.y_pos, MHITYOU, 250) != -1 )
          mpr("The picture comes to life!");
        break;
    ...
    case CARD_FIEND:
        ...
        if ( create_monster(MONS_FIEND, 21, BEH_ENSLAVED, you.x_pos, you.y_pos, MHITYOU, 250) != -1 )
          mpr("The picture comes to life!");
        break;
    ...
    case CARD_DRAGON:
        ...
        if ( create_monster(( coinflip() ? MONS_DRAGON : MONS_ICE_DRAGON ), 22, BEH_ENSLAVED, you.x_pos, you.y_pos, MHITYOU, 250) != -1 )
          mpr("The picture comes to life!");
        break;
    ...
    case CARD_GOLEM:
        ...
        if ( create_monster(MONS_CLAY_GOLEM + random2(6), 21, BEH_ENSLAVED, you.x_pos, you.y_pos, MHITYOU, 250) != -1 )
          mpr("The picture comes to life!");
        break;
    ...
    case CARD_THING_FUGLY:
        ...
        if ( create_monster(MONS_VERY_UGLY_THING, 21, BEH_ENSLAVED, you.x_pos, you.y_pos, MHITYOU, 250) != -1 )
          mpr("The picture comes to life!");
        break;

    case CARD_LICH:
        mpr("On the card is a picture of a very irritated-looking skeletal thing.");

        if ( create_monster(MONS_LICH, 0, BEH_CHASING_I, you.x_pos, you.y_pos, MHITYOU, 250) != -1 )
          mpr("The picture comes to life!");
        break;
    ...
    case CARD_HORROR_UNSEEN:
        ...
        if ( create_monster(MONS_UNSEEN_HORROR, 21, BEH_ENSLAVED, you.x_pos, you.y_pos, MHITYOU, 250) != -1
            && player_see_invis() )    // it is *VERY* important that the call to create_monster comes first here {dlb}
          mpr("The picture comes to life!");
        break;
...
// what about checking whether there are items there, too? {dlb}
    case CARD_FOUNTAIN:
        ...
        {
            strcpy(info, "A beautiful fountain of clear blue water grows from the floor ");
    ...
    case CARD_ALTAR:
        ...
        else
        {
            ...
            else
            {
                ...
                mpr("An altar awaits you elsewhere on this level!");
            }
        }
        break;
