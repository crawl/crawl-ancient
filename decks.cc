...
delete_mutation(100);
delete_mutation(100);
/*player_AC(you) += 2 + random() % 2 + random() % 2;
AC_ch = 1;*/
/*break;
case 13: // evasion
strcpy(info, "On the card is a picture of a butterfly."); // needs a new message
mpr(info);
strcpy(info, "You feel nimble. BUG this doesn't work");
mpr(info);
/*player_evasion(you) += 2 + random() % 2 + random() % 2;* /
you[0].evasion_ch = 1;
break;*/
/*case 14: // wizardry
strcpy(info, "On the card is a picture of a wizard's hat.");
mpr(info);
strcpy(info, "You feel powerful!");
mpr(info);
//you[0].mag_abil += 1 + random() % 3;
break;
case 15: // fire susceptible
strcpy(info, "On the card is a picture of a sausage on a barbeque.");
mpr(info);
strcpy(info, "You feel flammable!");
mpr(info);
//player_res_fire(you) --;
break;
case 16: // cold susceptible
strcpy(info, "On the card is a picture of you shivering with cold.");
mpr(info);
strcpy(info, "You feel susceptible to cold!"); //a momentary attack of hypothermia.");
mpr(info);
//player_res_cold(you) --;
break;
case 17: // fire resistant
strcpy(info, "On the card is a picture of an asbestos suit.");
mpr(info);
strcpy(info, "You feel resistant to fire.");
mpr(info);
//player_res_fire(you) ++;
break;
case 18: // cold resistant
strcpy(info, "On the card is a picture of a block of ice.");
mpr(info);
strcpy(info, "You feel resistant to cold.");
mpr(info);
//player_res_cold(you) ++;
break;
case 19: // life protection
strcpy(info, "On the card is a picture of you, surrounded by a holy aura.");
mpr(info);
strcpy(info, "You feel your life being protected.");
mpr(info);
//player_prot_life(you) ++;
break;
case 20: // resist lightning
strcpy(info, "On the card is a picture of you being struck by lightning.");
mpr(info);
strcpy(info, "You feel insulated.");
mpr(info);
you[0].attribute [0] ++;
break;
case 21: // resist poison
strcpy(info, "On the card is a picture of you drinking from a bottle labelled 'poison'.");
mpr(info);
strcpy(info, "You feel healthy.");
mpr(info);
//you[0].res_poison ++;
break;
case 22: // spec_death - not necessarily good
strcpy(info, "On the card is a picture of a grinning skull.");
mpr(info);
strcpy(info, "You feel in touch with the powers of death!");
mpr(info);
//you[0].spec_death ++;
break;*/
case 23: // reaper
