...

{
    ...
    { SPTYP_DIVINATION, 0, 0, 0 },
    { SPELL_LEVEL(6), SPELL_MANA(6), SPELL_FOOD(6), 0 },
},

{
    SPELL_TELEPORT_SELF, "Teleport Self",
    { SPTYP_TRANSLOCATION, 0, 0, 0 },
    { SPELL_LEVEL(5), SPELL_MANA(5), SPELL_FOOD(5), 0 },
},

{
    SPELL_CAUSE_FEAR, "Cause Fear",
    { SPTYP_ENCHANTMENT, 0, 0, 0 },
    { SPELL_LEVEL(5), SPELL_MANA(5), SPELL_FOOD(5), 0 },
},

{
    ...
    { SPTYP_ENCHANTMENT, 0, 0, 0 },
    { SPELL_LEVEL(1), SPELL_MANA(1), SPELL_FOOD(1), 0 },
},
...

{
    ...
    { SPTYP_CONJURATION, 0, 0, 0 },
    { SPELL_LEVEL(1), SPELL_MANA(1), SPELL_FOOD(1), 0 },
},

{
    SPELL_FIREBALL, "Fireball",
    { SPTYP_CONJURATION, SPTYP_FIRE, 0, 0 },
    { SPELL_LEVEL(6), SPELL_MANA(6), SPELL_FOOD(6), 0 },
},

{
    SPELL_CONJURE_FLAME, "Conjure Flame",
    { SPTYP_CONJURATION, SPTYP_FIRE, SPTYP_AIR, 0 },
    { SPELL_LEVEL(4), SPELL_MANA(4), SPELL_FOOD(4), 0 },
},

{
    SPELL_DIG, "Dig",
    { SPTYP_TRANSMIGRATION, SPTYP_EARTH, 0, 0 },
    { SPELL_LEVEL(4), SPELL_MANA(4), SPELL_FOOD(4), 0 },
},
...

{
    ...
    { SPTYP_CONJURATION, SPTYP_ICE, 0, 0 },
    { SPELL_LEVEL(5), SPELL_MANA(5), SPELL_FOOD(5), 0 },
},

{
    SPELL_LIGHTNING_BOLT, "Lightning Bolt",
    { SPTYP_CONJURATION, SPTYP_AIR, 0, 0 },
    { SPELL_LEVEL(6), SPELL_MANA(6), SPELL_FOOD(6), 0 },
},

{
    SPELL_BOLT_OF_MAGMA, "Bolt of Magma",
    { SPTYP_CONJURATION, SPTYP_FIRE, SPTYP_EARTH, 0 },
    { SPELL_LEVEL(5), 0, 0, 0 },
},

{
    SPELL_POLYMORPH_OTHER, "Polymorph Other",
    { SPTYP_ENCHANTMENT, SPTYP_TRANSMIGRATION, 0, 0 },
    { SPELL_LEVEL(5), SPELL_MANA(5), SPELL_FOOD(5), 0 },
},

{
    SPELL_SLOW, "Slow",
    { SPTYP_ENCHANTMENT, 0, 0, 0 },
    { SPELL_LEVEL(3), SPELL_MANA(3), SPELL_FOOD(3), 0 },
},

{
    SPELL_HASTE, "Haste",
    { SPTYP_ENCHANTMENT, 0, 0, 0 },
    { SPELL_LEVEL(8), SPELL_MANA(8), SPELL_FOOD(8), 0 },
},
...

{
    ...
    { SPTYP_CONJURATION, SPTYP_FIRE, 0, 0 },
    { SPELL_LEVEL(2), SPELL_MANA(2), SPELL_FOOD(2), 0 },
},
...

{
    ...
    { SPTYP_CONJURATION, SPTYP_ICE, SPTYP_AIR, 0 },
    { SPELL_LEVEL(7), SPELL_MANA(7), SPELL_FOOD(7), 0 },
},

{
    SPELL_MEPHITIC_CLOUD, "Mephitic Cloud",
    { SPTYP_CONJURATION, SPTYP_POISON, SPTYP_AIR, 0 },
    { SPELL_LEVEL(3), SPELL_MANA(3), SPELL_FOOD(3), 0 },
},

{
    SPELL_RING_OF_FLAMES, "Ring of Flames",
    { SPTYP_ENCHANTMENT, SPTYP_FIRE, 0, 0 },
    { SPELL_LEVEL(8), SPELL_MANA(8), SPELL_FOOD(8), 0 },
},
...

{
    ...
    { SPTYP_CONJURATION, SPTYP_POISON, 0, 0 },
    { SPELL_LEVEL(5), SPELL_MANA(5), SPELL_FOOD(5), 0 },
},
...

{
    ...
    { SPTYP_ENCHANTMENT, SPTYP_NECROMANCY, 0, 0 },
    { SPELL_LEVEL(8), SPELL_MANA(8), SPELL_FOOD(8), 0 },
},
...

{
    ...
    { SPTYP_SUMMONING, SPTYP_POISON, 0, 0 },
    { SPELL_LEVEL(4), SPELL_MANA(4), SPELL_FOOD(4), 0 },
},

{
    SPELL_LEVITATION, "Levitation",
    { SPTYP_ENCHANTMENT, SPTYP_AIR, 0, 0 },
    { SPELL_LEVEL(2), SPELL_MANA(2), SPELL_FOOD(2), 0 },
},

{
    SPELL_BOLT_OF_DRAINING, "Bolt of Draining",
    { SPTYP_CONJURATION, SPTYP_NECROMANCY, 0, 0 },
    { SPELL_LEVEL(6), SPELL_MANA(6), SPELL_FOOD(6), 0 },
},

{
    SPELL_LEHUDIBS_CRYSTAL_SPEAR, "Lehudib's Crystal Spear",
    { SPTYP_CONJURATION, SPTYP_EARTH, 0, 0 },
    { SPELL_LEVEL(8), SPELL_MANA(8), SPELL_FOOD(8), 0 },
},
...

{
    ...
    { SPTYP_CONJURATION, SPTYP_POISON, SPTYP_AIR, 0 },    // fixed {dlb}
    { SPELL_LEVEL(6), SPELL_MANA(6), SPELL_FOOD(6), 0 },
}
,

{
    ...
    { SPTYP_CONJURATION, SPTYP_FIRE, 0, 0 },
    { SPELL_LEVEL(9), SPELL_MANA(9), SPELL_FOOD(9), 0 },
},
...

{
    ...
    { SPTYP_DIVINATION, SPTYP_EARTH, 0, 0 },
    { SPELL_LEVEL(4), SPELL_MANA(4), SPELL_FOOD(4), 0 },
},
...

{
    ...
    { SPTYP_NECROMANCY, SPTYP_SUMMONING, 0, 0 },
    { SPELL_LEVEL(7), SPELL_MANA(7), SPELL_FOOD(7), 0 },
},
...

{
    ...
    { SPTYP_ICE, SPTYP_SUMMONING, 0, 0 },
    { SPELL_LEVEL(5), SPELL_MANA(5), SPELL_FOOD(5), 0 },
},

{
    SPELL_OZOCUBUS_ARMOUR, "Ozocubu's Armour",
    { SPTYP_ENCHANTMENT, SPTYP_ICE, 0, 0 },
    { SPELL_LEVEL(3), SPELL_MANA(3), SPELL_FOOD(3), 0 },
},
...

{
    ...
    { SPTYP_HOLY, SPTYP_AIR, 0, 0 },    // why is this the only holy spell with a secondary? {dlb}
    { SPELL_LEVEL(6), SPELL_MANA(6), SPELL_FOOD(6), 0 },
}
,
...

{
    ...
    { SPTYP_TRANSMIGRATION, SPTYP_NECROMANCY, 0, 0 },
    { SPELL_LEVEL(5), SPELL_MANA(5), SPELL_FOOD(5), 0 },
},
...

{
    ...
    { SPTYP_TRANSMIGRATION, SPTYP_EARTH, 0, 0 },    // jmf: was SPTYP_CONJURATION instead of SPTYP_TRANSMIGRATION
    { SPELL_LEVEL(7), SPELL_MANA(7), SPELL_FOOD(7), 0 },
}
,

{
    ...
    { SPTYP_ENCHANTMENT, SPTYP_EARTH, 0, 0 },
    { SPELL_LEVEL(6), SPELL_MANA(6), SPELL_FOOD(6), 0 },
},
...

{
    ...
    { SPTYP_TRANSMIGRATION, SPTYP_POISON, 0, 0 }, // jmf: was just SPTYP_POISON
    { SPELL_LEVEL(2), SPELL_MANA(2), SPELL_FOOD(2), 0 },
}
,

{
    ...
    { SPTYP_ENCHANTMENT, SPTYP_TRANSLOCATION, 0, 0 },
    { SPELL_LEVEL(4), SPELL_MANA(4), SPELL_FOOD(4), 0 },
},

{
    SPELL_POISON_AMMUNITION, "Poison Ammunition",
    { SPTYP_TRANSMIGRATION, SPTYP_POISON, 0, 0 },    // jmf: was SPTYP_ENCHANTMENT instead of SPTYP_TRANSMIGRATION
    { SPELL_LEVEL(4), SPELL_MANA(4), SPELL_FOOD(4), 0 },
}
,

{
    ...
    { SPTYP_ENCHANTMENT, SPTYP_POISON, 0, 0 },
    { SPELL_LEVEL(4), SPELL_MANA(4), SPELL_FOOD(4), 0 },
},
...
{
    SPELL_RECALL, "Recall",
    { SPTYP_SUMMONING, SPTYP_TRANSLOCATION, 0, 0 },
    { SPELL_LEVEL(3), SPELL_MANA(3), SPELL_FOOD(3), 0 },
},
...

{
    ...
    { SPTYP_TRANSMIGRATION, SPTYP_POISON, 0, 0 },
    { SPELL_LEVEL(3), SPELL_MANA(3), SPELL_FOOD(3), 0 },
},
...

{
    ...
    { SPTYP_ICE, SPTYP_TRANSMIGRATION, 0, 0 },
    { SPELL_LEVEL(5), SPELL_MANA(5), SPELL_FOOD(5), 0 },
},

{
    SPELL_DRAGON_FORM, "Dragon Form",
    { SPTYP_FIRE, SPTYP_TRANSMIGRATION, 0, 0 },
    { SPELL_LEVEL(8), SPELL_MANA(8), SPELL_FOOD(8), 0 },
},
...

{
    ...
    { SPTYP_CONJURATION, SPTYP_SUMMONING, 0, 0 }, // jmf: was just SPTYP_SUMMONING
    { SPELL_LEVEL(5), SPELL_MANA(5), SPELL_FOOD(5), 0 },
}
,
...

{
    ...
    { SPTYP_FIRE, SPTYP_TRANSMIGRATION, SPTYP_POISON, 0 },
    { SPELL_LEVEL(6), SPELL_MANA(6), SPELL_FOOD(6), 0 },
},

{
    SPELL_STICKS_TO_SNAKES, "Sticks to Snakes",
    { SPTYP_TRANSMIGRATION, SPTYP_SUMMONING, 0, 0 },
    { SPELL_LEVEL(2), SPELL_MANA(2), SPELL_FOOD(2), 0 },
},

{
    SPELL_SUMMON_LARGE_MAMMAL, "Summon Large Mammal",
    { SPTYP_SUMMONING, 0, 0, 0 },
    { SPELL_LEVEL(2), SPELL_MANA(2), SPELL_FOOD(2), 0 },
},

{
    ...
    { SPTYP_FIRE, SPTYP_SUMMONING, 0, 0 },
    { SPELL_LEVEL(9), SPELL_MANA(9), SPELL_FOOD(9), 0 },
},
...

{
    ...
    { SPTYP_ENCHANTMENT, SPTYP_DIVINATION, 0, 0 },
    { SPELL_LEVEL(4), SPELL_MANA(4), SPELL_FOOD(4), 0 },
},
...

{
    ...
    { SPTYP_TRANSMIGRATION, SPTYP_AIR, 0, 0 },
    { SPELL_LEVEL(9), SPELL_MANA(9), SPELL_FOOD(9), 0 },
},
...

{
    ...
    { SPTYP_ICE, SPTYP_TRANSMIGRATION, SPTYP_AIR, 0 },
    { SPELL_LEVEL(4), SPELL_MANA(4), SPELL_FOOD(4), 0 },
},
