...
static int spellbook_template_array[NUMBER_SPELLBOOKS][SPELLBOOK_SIZE] =
{
    ...
    {0,
     SPELL_ABJURATION_I,
     SPELL_RECALL,
     SPELL_SUMMON_DEMON /* SPELL_SUMMON_LARGE_MAMMAL */,
     SPELL_SUMMON_ELEMENTAL /* SPELL_SHADOW_CREATURES */,
     SPELL_SUMMON_ICE_BEAST /* SPELL_SUMMON_WRAITHS */,
     SPELL_SHADOW_CREATURES /* SPELL_SUMMON_HORRIBLE_THINGS */,
     SPELL_SUMMON_DRAGON /* SPELL_NO_SPELL */,
     SPELL_NO_SPELL,
     },
    // 8 - Book of Fire
    {0,
    ...
    {0,
     ...
     SPELL_DETECT_CURSE /* SPELL_DETECT_TRAPS */,
     SPELL_DETECT_ITEMS,
     SPELL_DETECT_TRAPS /* SPELL_MAGIC_MAPPING */,
     SPELL_IDENTIFY /* SPELL_NO_SPELL */,
     SPELL_SEE_INVISIBLE /* SPELL_NO_SPELL */,
     SPELL_NO_SPELL,
     SPELL_NO_SPELL
     },
    ...
    {0,
     ...
     SPELL_BLINK,
     SPELL_RECALL,
     SPELL_TELEPORT_SELF /* SPELL_TELEPORT_OTHER */,
     SPELL_TELEPORT_OTHER /* SPELL_TELEPORT_SELF */,
     SPELL_ANCHORED_TELEPORT /* SPELL_CONTROL_TELEPORT */,
     SPELL_CONTROL_TELEPORT /* SPELL_NO_SPELL */,
     SPELL_NO_SPELL,
     },
    ...
    {0,
     SPELL_CORPSE_ROT,
     SPELL_LETHAL_INFUSION /* SPELL_BONE_SHARDS */,
     SPELL_REGENERATION /* SPELL_LETHAL_INFUSION */,
     SPELL_AGONY,
    ...
    {0,
     SPELL_DETECT_CURSE /* SPELL_PROJECTED_NOISE */,
     SPELL_PROJECTED_NOISE /* SPELL_SELECTIVE_AMNESIA */,
     SPELL_SELECTIVE_AMNESIA /* SPELL_DETECT_CURSE */,
     SPELL_REMOVE_CURSE /* SPELL_DIG */,
     SPELL_DIG /* SPELL_REMOVE_CURSE */,
     SPELL_NO_SPELL,
     SPELL_NO_SPELL,
     SPELL_NO_SPELL,
     },
    ...
    {0,
     ...
     SPELL_BONE_SHARDS /* SPELL_REGENERATION */,
     SPELL_DISPEL_UNDEAD,
     SPELL_ANIMATE_DEAD,
     SPELL_NO_SPELL,
     SPELL_NO_SPELL,
    ...
    {0,
     ...
     SPELL_STICKS_TO_SNAKES,
     SPELL_CALL_IMP,
     SPELL_SUMMON_LARGE_MAMMAL /* SPELL_SUMMON_ELEMENTAL */,
     SPELL_SUMMON_GHOST /* SPELL_SUMMON_SCORPIONS */,
     SPELL_SUMMON_SCORPIONS /* SPELL_SUMMON_ICE_BEAST */,
     SPELL_NO_SPELL,
     SPELL_NO_SPELL,
     },
    // 26 - Book of Charms
    ...
    {0,
     SPELL_DEMONIC_HORDE /* SPELL_ABJURATION_I */,
     SPELL_SUMMON_GREATER_DEMON /* SPELL_RECALL */,
     SPELL_BANISHMENT /* SPELL_CALL_IMP */,
     SPELL_AGONY /* SPELL_SUMMON_DEMON */,
     SPELL_SUMMON_WRAITHS /* SPELL_DEMONIC_HORDE */,
     SPELL_SUMMON_HORRIBLE_THINGS /* SPELL_SUMMON_GREATER_DEMON */,
     SPELL_NO_SPELL,
     SPELL_NO_SPELL,
     },
    // 28 - Book of Air
    ...
    {0,
     SPELL_DETECT_CREATURES /* SPELL_DETECT_SECRET_DOORS */,
     SPELL_IDENTIFY /* SPELL_DETECT_CREATURES */,
     SPELL_MAGIC_MAPPING /* SPELL_DETECT_ITEMS */,
     SPELL_FORESCRY /* SPELL_DETECT_CURSE */,
     SPELL_VIRTUAL_DEATH /* SPELL_SEE_INVISIBLE */,
     SPELL_BRAINSTORM /* SPELL_FORESCRY */,
     SPELL_MYSTIC_GRASP /* SPELL_IDENTIFY */,
     SPELL_NO_SPELL,
     },
    // 31 - Book of the Warp
    {0,
     ...
     SPELL_BANISHMENT,
     SPELL_BAZAAR_OF_NANIWA /* SPELL_DISPERSAL */,
     SPELL_DISPERSAL /* SPELL_PORTAL */,
     SPELL_PORTAL /* SPELL_NO_SPELL */,
     SPELL_LOCAL_GLOBAL /* SPELL_NO_SPELL */,
     SPELL_NO_SPELL,
     SPELL_NO_SPELL,
     },
    ...
    {0,
     ...
     SPELL_IDENTIFY /* SPELL_SUMMON_ELEMENTAL */,
     SPELL_TELEPORT_SELF /* SPELL_MAGIC_MAPPING */,
     SPELL_SUMMON_ELEMENTAL /* SPELL_TELEPORT_SELF */,
     SPELL_MAGIC_MAPPING /* SPELL_FIREBALL */,
     SPELL_FIREBALL /* SPELL_IDENTIFY */,
     SPELL_HASTE,
     SPELL_NO_SPELL,
     },
    // 43 - Book of Power
