...

{
    ...
    M_RES_POISON | M_SEE_INVIS | M_SPLITS,
...

{
    ...
    M_RES_POISON | M_RES_COLD | M_RES_ELEC | M_SPELLCASTER | M_SEE_INVIS,
...

{
    ...
    { 3, 0, 0, 0 },
    { 1, 1, 2, 0 },
    0, 11, 10, 7, MST_NO_SPELLS, CE_CLEAN, Z_SMALL, S_SILENT, I_REPTILE,
    MONUSE_NOTHING
}
,

{
    ...
    { 5, 0, 0, 0 },
    { 1, 3, 5, 0 },
    1, 13, 12, 7, MST_NO_SPELLS, CE_CLEAN, Z_SMALL, S_SILENT, I_REPTILE,
    MONUSE_NOTHING
}
,

{
    ...
    { 15, 0, 0, 0 },
    { 3, 3, 5, 0 },
    3, 10, 10, 7, MST_NO_SPELLS, CE_CLEAN, Z_SMALL, S_HISS, I_REPTILE,
    MONUSE_NOTHING
}
,

{
    ...
    { 20, 0, 0, 0 },
    { 5, 4, 4, 0 },
    4, 9, 10, 7, MST_NO_SPELLS, CE_POISONOUS, Z_BIG, S_HISS, I_REPTILE,
    MONUSE_NOTHING
}
,

{
    ...
    { 30, 0, 0, 0 },
    { 8, 3, 5, 0 },
    6, 8, 10, 7, MST_NO_SPELLS, CE_CONTAMINATED, Z_BIG, S_HISS, I_REPTILE,
    MONUSE_NOTHING
}
,
