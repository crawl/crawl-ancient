...

{
    ...
    { 20, 0, 0, 0 },
    { 9, 3, 5, 0 },
    10, 10, 10, 7, MST_ANGEL, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT, I_HIGH, 3
}
,
...

{
    ...
    { 19, 0, 0, 0 },
    { 8, 3, 5, 0 },
    6, 14, 15, 7, MST_GUARDIAN_NAGA, CE_MUTAGEN_RANDOM, Z_SMALL, S_SHOUT, I_HIGH, 1
}
,
...

{
    ...
    { 20, 0, 0, 0 },
    { 10, 3, 5, 0 },
    10, 14, 10, 7, MST_RAKSHASA, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT, I_HIGH, 3
}
,
...

{
    ...
    { 22, 0, 0, 0 },
    { 6, 3, 5, 0 },
    10, 10, 10, 7, MST_VAMPIRE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT, I_NORMAL, 3
}
,
...

{
    ...
    { 4, 0, 0, 0 },
    { 4, 3, 5, 0 },
    2, 13, 10, 7, MST_KOBOLD_DEMONOLOGIST, CE_POISONOUS, Z_NOZOMBIE, S_SHOUT, I_NORMAL, 3
}
,
...

{
    ...
    { 12, 0, 0, 0 },
    { 7, 3, 5, 0 },
    10, 5, 10, 7, MST_EFREET, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT, I_HIGH, 3
}
,

{
    ...
    { 0, 0, 0, 0 },
    { 5, 3, 3, 0 },
    1, 5, 10, 7, MST_BRAIN_WORM, CE_POISONOUS, Z_SMALL, S_SILENT, I_REPTILE, 0
}
,

{
    ...
    { 0, 0, 0, 0 },
    { 10, 3, 5, 0 },
    2, 4, 10, 7, MST_GIANT_ORANGE_BRAIN, CE_MUTAGEN_RANDOM, Z_NOZOMBIE, S_SILENT, I_HIGH, 1
}
,
...

{
    ...
    { 20, 0, 0, 0 },
    { 12, 3, 5, 0 },
    10, 3, 10, 7, MST_GREAT_ORB_OF_EYES, CE_MUTAGEN_RANDOM, Z_NOZOMBIE, S_SILENT, I_HIGH, 1
}
,
...

{
    ...
    { 8, 8, 0, 0 },
    { 7, 3, 5, 0 },
    12, 12, 13, 7, MST_TORMENTOR, CE_NOCORPSE, Z_NOZOMBIE, S_ROAR, I_HIGH, 1
}
,
...

{
    ...
    { 12, 0, 0, 0 },
    { 4, 5, 5, 0 },
    5, 10, 10, 7, MST_STEAM_DRAGON, CE_CLEAN, Z_BIG, S_SILENT, I_ANIMAL_LIKE, 1
}
,
...

{
    ...
    { 7, 0, 0, 0 },
    { 8, 2, 3, 0 },
    5, 12, 10, 7, MST_ORC_SORCEROR, CE_POISONOUS, Z_SMALL, S_SHOUT, I_HIGH, 3
}
,
...

{
    MONS_HYDRA, 'D', LIGHTGREEN, "hydra",
      M_RES_POISON, //jmf: warm blood? cold blood?
...

{
    ...
    { 6, 0, 0, 0 },
    { 3, 3, 4, 0 },
    1, 10, 10, 7, MST_ORC_PRIEST, CE_CONTAMINATED, Z_SMALL, S_SHOUT, I_NORMAL, 3
}
,

{
    ...
    { 7, 0, 0, 0 },
    { 11, 3, 4, 0 },
    1, 12, 10, 7, MST_ORC_HIGH_PRIEST, CE_CONTAMINATED, Z_SMALL, S_SHOUT, I_HIGH, 3
}
,
...

{
    ...
    { 6, 0, 0, 0 },
    { 1, 3, 5, 0 },
    0, 10, 10, 7, 250, CE_CLEAN, Z_SMALL, S_SHOUT, I_NORMAL, 3
}
,
...

{
    ...
    { 15, 0, 0, 0 },
    { 5, 3, 5, 0 },
    5, 10, 10, 7, MST_MOTTLED_DRAGON, CE_POISONOUS, Z_BIG, S_SILENT, I_ANIMAL_LIKE, 1
}
,
...

{
    ...
    { 25, 25, 0, 0 },
    { 18, 3, 5, 0 },
    15, 6, 10, 7, MST_ICE_FIEND, CE_CONTAMINATED, Z_NOZOMBIE, S_ROAR, I_HIGH, 1
}
,

{
    ...
    { 25, 15, 15, 0 },
    { 18, 3, 5, 0 },
    15, 6, 10, 7, MST_SHADOW_FIEND, CE_CONTAMINATED, Z_NOZOMBIE, S_ROAR, I_HIGH, 1
}
,
...

{
    ...
    { 25, 15, 15, 0 },
    { 14, 5, 5, 0 },
    13, 10, 12, 7, MST_STORM_DRAGON, CE_CLEAN, Z_BIG, S_ROAR, I_NORMAL, 1
}
,

{
    ...
    { 15, 0, 0, 0 },
    { 8, 3, 5, 0 },
    4, 4, 10, 7, 250, CE_CLEAN, Z_BIG, S_SHOUT, I_NORMAL, 3
}
,
...

{
    ...
    { 0, 0, 0, 0 },
    { 12, 2, 3, 0 },
    0, 12, 10, 7, MST_STORM_DRAGON, CE_CONTAMINATED, Z_NOZOMBIE, S_SILENT, I_PLANT, 0
}
,

{
    ...
    { 12, 0, 0, 0 },
    { 10, 3, 5, 0 },
    1, 7, 10, 7, 250, CE_CONTAMINATED, Z_BIG, S_SHOUT, I_HIGH, 3
}
,
...

{
    ...
    M_RES_ELEC | M_SPELLCASTER | M_WARM_BLOOD,
    3500, 12, 145, MH_NATURAL, -7,
    { 55, 0, 0, 0 },
    { 20, 3, 5, 0 },
    10, 3, 10, 7, MST_TITAN, CE_CLEAN, Z_BIG, S_SHOUT, I_HIGH, 1
}
,

{
    ...
    { 40, 20, 20, 0 },
    { 18, 4, 4, 0 },
    15, 7, 10, 7, MST_GOLDEN_DRAGON, CE_POISONOUS, Z_BIG, S_ROAR, I_HIGH, 1
}
,
...

{
    ...
    { 6, 0, 0, 0 },
    { 5, 3, 5, 0 },
    6, 10, 8, 7, MST_NAGA, CE_POISONOUS, Z_SMALL, S_SHOUT, I_NORMAL, 3
}
,

{
    MONS_FIRE_GIANT, 'C', RED, "fire giant",
    M_RES_FIRE | M_SPELLCASTER | M_WARM_BLOOD,
    2400, 11, 162, MH_NATURAL, -4,
    { 30, 0, 0, 0 },
    { 16, 3, 6, 0 },
    8, 4, 10, 7, MST_EFREET, CE_CONTAMINATED, Z_BIG, S_SHOUT, I_NORMAL, 3
}
,

{
    MONS_FROST_GIANT, 'C', LIGHTBLUE, "frost giant",
    M_RES_COLD | M_SPELLCASTER | M_WARM_BLOOD,
    2600, 11, 163, MH_NATURAL, -4,
    { 35, 0, 0, 0 },
    { 16, 4, 5, 0 },
    9, 3, 10, 7, MST_FROST_GIANT, CE_CONTAMINATED, Z_BIG, S_SHOUT, I_NORMAL, 3
}
,
...

{
    ...
    { 20, 15, 15, 0 },
    { 17, 5, 5, 0 },
    15, 10, 10, 7, MST_SHADOW_DRAGON, CE_CLEAN, Z_BIG, S_ROAR, I_HIGH, 1
}
,
...

{
    ...
    { 13, 9, 9, 0 },
    { 9, 5, 5, 0 },
    7, 7, 9, 7, MST_SWAMP_DRAGON, CE_CONTAMINATED, Z_BIG, S_ROAR, I_ANIMAL_LIKE, 1
}
,

{
    ...
    { 11, 0, 0, 0 },
    { 4, 5, 5, 0 },
    3, 11, 11, 7, MST_SWAMP_DRAKE, CE_CONTAMINATED, Z_SMALL, S_ROAR, I_ANIMAL_LIKE, 1
}
,
...

{
    ...
    { 4, 0, 0, 0 },
    { 2, 3, 5, 0 },
    4, 10, 10, 7, MST_WHITE_IMP, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT, I_NORMAL, 1
}
,
...

{
    ...
    { 15, 0, 0, 0 },
    { 6, 3, 5, 0 },
    4, 12, 10, 7, MST_NEQOXEC, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT, I_NORMAL, 1
}
,
...

{
    ...
    { 17, 10, 0, 0 },
    { 7, 4, 5, 0 },
    8, 10, 10, 7, MST_HELLWING, CE_CONTAMINATED, Z_NOZOMBIE, S_MOAN, I_NORMAL, 1
}
,

{
    ...
    { 8, 5, 5, 0 },
    { 7, 3, 5, 0 },
    5, 9, 9, 7, MST_SMOKE_DEMON, CE_CONTAMINATED, Z_NOZOMBIE, S_ROAR, I_NORMAL, 3
}
,

{
    ...
    { 12, 0, 0, 0 },
    { 6, 3, 5, 0 },
    3, 10, 10, 7, MST_YNOXINUL, CE_CONTAMINATED, Z_NOZOMBIE, S_BELLOW, I_NORMAL, 1
}
,
...

{
    ...
    { 32, 0, 0, 0 },
    { 13, 3, 5, 0 },
    5, 7, 12, 7, MST_GREEN_DEATH, CE_CONTAMINATED, Z_NOZOMBIE, S_ROAR, I_HIGH, 1
}
,
...

{
    ...
    { 25, 0, 0, 0 },
    { 14, 3, 5, 0 },
    5, 12, 12, 7, MST_BALRUG, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT, I_HIGH, 3
}
,

{
    ...
    { 22, 0, 0, 0 },
    { 13, 3, 5, 0 },
    11, 10, 10, 7, MST_CACODEMON, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT, I_HIGH, 1
}
,
...

{
    ...
    { 6, 0, 0, 0 },
    { 2, 3, 5, 0 },
    3, 11, 10, 7, MST_SHADOW_IMP, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT, I_NORMAL, 1
}
,
...

{
    ...
    { 23, 23, 0, 0 },
    { 17, 0, 0, 199 },
    10, 13, 13, 7, MST_MNOLEG, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT, I_HIGH, 1
}
,

{
    ...
    { 40, 0, 0, 0 },
    { 19, 0, 0, 223 },
    10, 7, 8, 7, MST_LOM_LOBON, CE_CONTAMINATED, Z_NOZOMBIE, S_SILENT, I_HIGH, 1
}
,

{
    ...
    { 50, 0, 0, 0 },
    { 21, 0, 0, 253 },
    15, 8, 10, 7, MST_CEREBOV, CE_CONTAMINATED, Z_NOZOMBIE, S_SILENT, I_NORMAL, 3
}
,

{
    ...
    { 20, 0, 0, 0 },
    { 16, 0, 0, 234 },
    10, 10, 10, 7, MST_GLOORX_VLOQ, CE_CONTAMINATED, Z_NOZOMBIE, S_MOAN, I_HIGH, 1
}
,
...

{
    ...
    { 5, 0, 0, 0 },
    { 7, 3, 5, 0 },
    6, 10, 8, 7, MST_NAGA_MAGE, CE_POISONOUS, Z_SMALL, S_SHOUT, I_NORMAL, 3
}
,
...

{
    ...
    { 5, 0, 0, 0 },
    { 6, 3, 3, 0 },
    0, 13, 10, 7, MST_DEEP_ELF_SUMMONER, CE_CONTAMINATED, Z_SMALL, S_SHOUT, I_HIGH, 3
}
,
...

{
    ...
    { 9, 0, 0, 0 },
    { 5, 3, 3, 0 },
    0, 13, 10, 7, MST_DEEP_ELF_PRIEST, CE_CONTAMINATED, Z_SMALL, S_SHOUT, I_HIGH, 3
}
,

{
    MONS_DEEP_ELF_HIGH_PRIEST, 'e', DARKGREY, "deep elf high priest",
    M_SPELLCASTER | M_SPEAKS | M_PRIEST | M_WARM_BLOOD,
    450, 10, 147, MH_NATURAL, -6,
    { 14, 0, 0, 0 },
    { 11, 3, 3, 0 },
    3, 13, 10, 7, MST_DEEP_ELF_HIGH_PRIEST, CE_CONTAMINATED, Z_SMALL, S_SHOUT, I_HIGH, 3
}
,

{
    ...
    { 12, 0, 0, 0 },
    { 12, 3, 3, 0 },
    0, 13, 10, 7, MST_DEEP_ELF_DEMONOLOGIST, CE_CONTAMINATED, Z_SMALL, S_SHOUT, I_HIGH, 3
}
,

{
    ...
    { 12, 0, 0, 0 },
    { 15, 3, 3, 0 },
    0, 13, 10, 7, MST_DEEP_ELF_ANNIHILATOR, CE_CONTAMINATED, Z_SMALL, S_SHOUT, I_HIGH, 3
}
,

{
    ...
    { 12, 0, 0, 0 },
    { 14, 3, 3, 0 },
    0, 13, 10, 7, MST_DEEP_ELF_SORCEROR, CE_CONTAMINATED, Z_SMALL, S_SHOUT, I_HIGH, 3
}
,

{
    ...
    { 12, 0, 0, 0 },
    { 15, 3, 3, 0 },
    0, 13, 10, 7, MST_DEEP_ELF_DEATH_MAGE, CE_CONTAMINATED, Z_SMALL, S_SHOUT, I_HIGH, 3
}
,
...

{
    ...
    { 4, 0, 0, 0 },
    { 1, 0, 0, 10 },
    0, 10, 10, 7, MST_ORC_WIZARD_I, CE_CONTAMINATED, Z_SMALL, S_SHOUT, I_NORMAL, 3
}
,
...

{
    ...
    { 5, 0, 0, 0 },
    { 3, 0, 0, 25 },
    0, 11, 10, 7, MST_ORC_WIZARD_II, CE_CONTAMINATED, Z_SMALL, S_SHOUT, I_NORMAL, 3
}
,

{
    ...
    { 7, 0, 0, 0 },
    { 3, 0, 0, 32 },
    0, 9, 8, 7, MST_ORC_WIZARD_III, CE_CONTAMINATED, Z_SMALL, S_SHOUT, I_NORMAL, 3
}
,
...

{
    ...
    { 7, 0, 0, 0 },
    { 5, 0, 0, 24 },
    0, 12, 13, 7, MST_ORC_WIZARD_III, CE_CONTAMINATED, Z_SMALL, S_SHOUT, I_NORMAL, 3
}
,
...

{
    ...
    { 9, 0, 0, 0 },
    { 6, 0, 0, 36 },
    0, 10, 10, 7, MST_ORC_WIZARD_III, CE_CONTAMINATED, Z_SMALL, S_SHOUT, I_NORMAL, 3
}
,
...

{
    ...
    { 10, 0, 0, 0 },
    { 9, 0, 0, 43 },
    0, 11, 11, 7, MST_WIZARD_II, CE_CONTAMINATED, Z_SMALL, S_SHOUT, I_NORMAL, 3
}
,

{
    ...
    { 11, 0, 0, 0 },
    { 9, 0, 0, 47 },
    0, 10, 10, 7, MST_NECROMANCER_I, CE_CONTAMINATED, Z_SMALL, S_SHOUT, I_NORMAL, 3
}
,

{
    ...
    { 12, 0, 0, 0 },
    { 9, 0, 0, 51 },
    0, 8, 10, 7, MST_HELL_KNIGHT_II, CE_CONTAMINATED, Z_SMALL, S_SHOUT, I_NORMAL, 3
}
,
...

{
    ...
    { 14, 0, 0, 0 },
    { 11, 0, 0, 60 },
    0, 9, 10, 7, MST_GUARDIAN_NAGA, CE_CONTAMINATED, Z_SMALL, S_SHOUT, I_NORMAL, 3
}
,
...

{
    ...
    { 12, 0, 0, 0 },
    { 13, 0, 0, 52 },
    0, 10, 10, 7, MST_WIZARD_IV, CE_CONTAMINATED, Z_SMALL, S_SHOUT, I_NORMAL, 3
}
,

{
    ...
    { 12, 0, 0, 0 },
    { 14, 0, 0, 67 },
    0, 10, 10, 7, MST_ORC_HIGH_PRIEST, CE_CONTAMINATED, Z_SMALL, S_SHOUT, I_NORMAL, 3
}
,
...

{
    ...
    { 14, 0, 0, 0 },
    { 17, 0, 0, 78 },
    1, 10, 7, 7, MST_ORC_PRIEST, CE_CONTAMINATED, Z_SMALL, S_SHOUT, I_NORMAL, 3
}
,
...

{
    ...
    { 16, 0, 0, 0 },
    { 20, 0, 0, 95 },
    1, 9, 9, 7, MST_HELL_KNIGHT_II, CE_CONTAMINATED, Z_SMALL, S_SHOUT, I_NORMAL, 3
}
,

{
    ...
    { 17, 0, 0, 0 },
    { 21, 0, 0, 105 },
    0, 10, 10, 7, MST_LICH_IV, CE_CONTAMINATED, Z_SMALL, S_SHOUT, I_NORMAL, 3
}
,

{
    ...
    { 18, 0, 0, 0 },
    { 22, 0, 0, 119 },
    0, 10, 10, 7, MST_EFREET, CE_CONTAMINATED, Z_SMALL, S_SHOUT, I_NORMAL, 3
}
,

{
    ...
    { 15, 0, 0, 0 },
    { 22, 0, 0, 99 },
    12, 10, 10, 7, MST_LICH_IV, CE_CONTAMINATED, Z_SMALL, S_SHOUT, I_HIGH, 1
}
,
...

{
    ...
    { 30, 0, 0, 0 },
    { 15, 0, 0, 240 },
    15, 6, 10, 7, MST_GERYON, CE_CONTAMINATED, Z_NOZOMBIE, S_ROAR, I_NORMAL, 1
}
,

{
    ...
    { 15, 0, 0, 0 },
    { 16, 0, 0, 222 },
    15, 3, 6, 7, MST_DISPATER, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT, I_HIGH, 3
}
,

{
    ...
    { 20, 0, 0, 0 },
    { 17, 0, 0, 245 },
    12, 7, 9, 7, MST_ASMODEUS, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT, I_HIGH, 3
}
,

{
    ...
    { 30, 0, 0, 0 },
    { 22, 0, 0, 250 },
    10, 4, 7, 7, MST_ANTAEUS, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT, I_HIGH, 3
}
,

{
    ...
    { 20, 0, 0, 0 },
    { 18, 0, 0, 238 },
    15, 6, 9, 7, MST_ERESHKIGAL, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT, I_HIGH, 3
}
,
   ...
   placed in the Crypt. */
{
    ...
    { 0, 0, 0, 0 },
    { 13, 0, 0, 66 },
    40, 3, 10, 7, MST_CURSE_SKULL, CE_NOCORPSE, Z_NOZOMBIE, S_MOAN, I_HIGH, 0
}
,

{
    ...
    { 33, 0, 0, 0 },
    { 11, 3, 7, 0 },
    10, 10, 10, 7, MST_VAMPIRE_KNIGHT, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT, I_HIGH, 3
}
,

{
    ...
    { 22, 0, 0, 0 },
    { 8, 3, 4, 0 },
    10, 10, 10, 7, MST_VAMPIRE_MAGE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT, I_HIGH, 3
}
,

{
    ...
    { 0, 0, 0, 0 },
    { 10, 3, 5, 0 },
    3, 1, 7, 7, MST_SHINING_EYE, CE_POISONOUS, Z_NOZOMBIE, S_SILENT, I_PLANT, 0
}
,
...

{
    ...
    { 25, 0, 0, 0 },
    { 12, 3, 5, 0 },
    10, 13, 13, 7, MST_DAEVA, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT, I_HIGH, 3
}
,
...

{
    ...
    { 18, 0, 0, 0 },
    { 15, 3, 5, 0 },
    6, 10, 8, 7, MST_NAGA_MAGE, CE_POISONOUS, Z_SMALL, S_SHOUT, I_HIGH, 3
}
,
...

{
    ...
    { 25, 12, 12, 0 },
    { 16, 3, 5, 0 },
    5, 5, 13, 7, MST_SPHINX, CE_CLEAN, Z_NOZOMBIE, S_SHOUT, I_HIGH, 1
}
,
...

{
    ...
    { 35, 0, 0, 0 },
    { 15, 5, 3, 100 },
    10, 6, 10, 7, MST_MUMMY, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT, I_PLANT, 3
}
,

{
    ...
    { 30, 0, 0, 0 },
    { 10, 5, 3, 0 },
    8, 7, 9, 7, MST_MUMMY, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT, I_PLANT, 3
}
,
...

{
    ...
    { 23, 0, 0, 0 },
    { 14, 3, 5, 0 },
    5, 5, 10, 7, 250, CE_CLEAN, Z_BIG, S_SHOUT, I_NORMAL, 3
}
,

{
    ...
    { 30, 0, 0, 0 },
    { 20, 5, 5, 0 },
    10, 15, 15, 7, MST_ORC_WIZARD_II, CE_CONTAMINATED, Z_SMALL, S_SHOUT, I_HIGH, 1
}
,

{
    ...
    { 30, 0, 0, 0 },
    { 15, 7, 4, 0 },
    5, 20, 20, 7, MST_ELECTRIC_GOLEM, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT, I_PLANT, 1
}
,
...

{
    ...
    { 0, 0, 0, 0 },
    { 10, 3, 5, 0 },
    12, 1, 7, 7, MST_EYE_OF_DEVASTATION, CE_POISONOUS, Z_NOZOMBIE, S_SILENT, I_PLANT, 0
}
,
...

{
    ...
    { 0, 0, 0, 0 },
    { 14, 0, 0, 77 },
    50, 1, 12, 7, MST_CURSE_SKULL, CE_NOCORPSE, Z_NOZOMBIE, S_MOAN, I_HIGH, 0
}
,
...

{
    ...
    { 20, 0, 0, 0 },
    { 11, 3, 5, 0 },
    2, 9, 14, 7, MST_HELL_HOG, CE_CLEAN, Z_NOZOMBIE, S_SILENT, I_ANIMAL, 0
}
,

{
    ...
    { 35, 15, 15, 0 },
    { 20, 4, 4, 0 },
    12, 9, 14, 7, MST_SERPENT_OF_HELL, CE_CLEAN, Z_NOZOMBIE, S_ROAR, I_HIGH, 1
}
,

{
    ...
    { 5, 0, 0, 0 },
    { 2, 3, 5, 0 },
    0, 12, 12, 7, MST_BOGGART, CE_CONTAMINATED, Z_SMALL, S_SHOUT, I_NORMAL, 3
}
,

{
    ...
    { 45, 0, 0, 0 },
    { 16, 3, 5, 0 },
    10, 15, 15, 7, MST_QUICKSILVER_DRAGON, CE_CONTAMINATED, Z_SMALL, S_ROAR, I_HIGH, 1
}
,

{
    ...
    { 25, 25, 25, 0 },
    { 18, 5, 3, 0 },
    20, 6, 8, 7, MST_IRON_DRAGON, CE_CONTAMINATED, Z_SMALL, S_ROAR, I_HIGH, 1
}
,

{
    ...
    { 25, 0, 0, 0 },
    { 10, 5, 3, 0 },
    15, 10, 10, 7, MST_SKELETAL_WARRIOR, CE_CONTAMINATED, Z_SMALL, S_SILENT, I_NORMAL, 3
}
,
...
/* player ghost - only one per level. stats are stored in ghost struct */
{
    ...
    { 5, 0, 0, 0 },
    { 4, 2, 3, 0 },
    1, 2, 10, 7, MST_GHOST, CE_CONTAMINATED, Z_NOZOMBIE, S_SILENT, I_HIGH, 1
}
,
...
/* random demon in pan - only one per level. stats are stored in ghost struct */
{
    ...
    { 5, 0, 0, 0 },
    { 4, 2, 3, 0 },
    1, 2, 10, 7, MST_GHOST, CE_CONTAMINATED, Z_NOZOMBIE, S_RANDOM, I_HIGH, 1
}
,
...
{  // mv: was another lava thing
    ...
    { 23, 0, 0, 0 },
    { 14, 3, 5, 0 },
    5, 5, 10, 7, 250, CE_NOCORPSE, Z_SMALL, S_SILENT, I_HIGH, 3
}
