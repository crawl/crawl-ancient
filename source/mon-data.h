...

{
    ...
    { 10, 0, 0, 0 },
    { 4, 3, 5, 0 },
    3, 7, 10 /* 15 */, 7, MST_NO_SPELLS, CE_CLEAN, Z_BIG, S_SHOUT, I_NORMAL,
...

{
    ...
    750, 10, MONS_VERY_UGLY_THING, MH_NATURAL, -3,
      { 22 /*17*/, 17 /*0*/, 0, 0 },
    { 12, 3, 5, 0 },
      14 /*4*/, 14 /*8*/, 8, 7, MST_NO_SPELLS, CE_MUTAGEN_RANDOM, Z_BIG, S_SHOUT, I_NORMAL,
    MONUSE_OPEN_DOORS
}
,
...

{
    ...
    { 15, 0, 0, 0 },
    { 8, 3, 5, 0 },
    4, 4, 15 /* 10 */, 7, MST_NO_SPELLS, CE_CLEAN, Z_BIG, S_SHOUT, I_NORMAL,
    MONUSE_WEAPONS_ARMOUR
}
,
...

{
    ...
    { 6, 0, 0, 0 },
    { 5, 3, 5, 0 },
      6, 10, 10 /*8*/, 7, MST_NAGA, CE_POISONOUS, Z_SMALL, S_SHOUT, I_NORMAL,
    MONUSE_WEAPONS_ARMOUR
}
,
...

{
    ...
    { 23, 23, 0, 0 },
    { 17, 0, 0, 199 },
    10, 23 /*13*/, 13, 7, MST_MNOLEG, CE_CONTAMINATED, Z_NOZOMBIE, S_BUZZ, I_HIGH,
    MONUSE_OPEN_DOORS
}
,

{
    ...
    { 40, 0, 0, 0 },
    { 19, 0, 0, 223 },
    10, 17 /* 7 */, 8, 7, MST_LOM_LOBON, CE_CONTAMINATED, Z_NOZOMBIE, S_SCREAM, I_HIGH,
    MONUSE_OPEN_DOORS
}
,

{
    ...
    { 50, 0, 0, 0 },
    { 21, 0, 0, 253 },
    15, 18 /* 8 */, 10, 7, MST_CEREBOV, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT, I_NORMAL,
    MONUSE_WEAPONS_ARMOUR
}
,

{
    ...
    { 20, 0, 0, 0 },
    { 16, 0, 0, 234 },
    10, 20 /* 10 */, 10, 7, MST_GLOORX_VLOQ, CE_CONTAMINATED, Z_NOZOMBIE, S_MOAN, I_HIGH,
    MONUSE_OPEN_DOORS
}
,
...

{
    ...
    { 5, 0, 0, 0 },
    { 7, 3, 5, 0 },
      6, 10, 10 /*8*/, 7, MST_NAGA_MAGE, CE_POISONOUS, Z_SMALL, S_SHOUT, I_NORMAL,
    MONUSE_WEAPONS_ARMOUR
}
,
...

{
    ...
    { 5, 0, 0, 0 },
    { 3, 0, 0, 25 },
      0, 11, 6 /* 10 */, 7, MST_ORC_WIZARD_II, CE_CONTAMINATED, Z_SMALL, S_SHOUT, I_NORMAL,
    MONUSE_WEAPONS_ARMOUR
}
,
...
,
  ...
  /* don't complain about these demon lords; they are here to kill you */
{
    ...
    { 90 /* 15 */, 60 /* 0 */, 60 /* 0 */, 0 },
    { 16, 0, 0, 222 },
    15, 3, 10 /* 6 */, 7, MST_DISPATER, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT, I_HIGH,
    MONUSE_WEAPONS_ARMOUR
}
,

{
    ...
    { 108 /* 20 */, 72 /* 0 */, 72 /* 0 */, 0 },
    { 17, 0, 0, 245 },
    12, 7, 10 /* 9 */, 7, MST_ASMODEUS, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT, I_HIGH,
    MONUSE_WEAPONS_ARMOUR
}
,
...
// Antaeus is now demonic so that he'll resist torment. -- bwr
{
    ...
    { 144 /* 30 */, 96 /* 0 */, 96 /* 0 */, 0 },
    { 22, 0, 0, 250 },
    10, 4, 10 /* 7 */, 7, MST_ANTAEUS, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT, I_HIGH,
    MONUSE_WEAPONS_ARMOUR
}
,

{
    ...
    { 108 /* 20 */, 72 /* 0 */, 72 /* 0 */, 0 },
    { 18, 0, 0, 238 },
    15, 6, 10 /* 9 */, 7, MST_ERESHKIGAL, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT, I_HIGH,
    MONUSE_WEAPONS_ARMOUR
}
,
...

{
    ...
    M_NO_SKELETON | M_SEE_INVIS,
      */
    M_NO_SKELETON | M_SEE_INVIS | M_INVIS,
...

{
    ...
    { 18, 0, 0, 0 },
    { 15, 3, 5, 0 },
      6, 10, 10 /*8*/, 7, MST_NAGA_MAGE, CE_POISONOUS, Z_SMALL, S_SHOUT, I_HIGH,
    MONUSE_WEAPONS_ARMOUR
}
,
...

{
    ...
    { 16, 0, 0, 0 },
    { 9, 3, 5, 0 },
    4, 8, 10 /* 15 */, 7, MST_NO_SPELLS, CE_CLEAN, Z_BIG, S_SHOUT, I_HIGH,
    MONUSE_WEAPONS_ARMOUR
}
,

{
    ...
    { 23, 0, 0, 0 },
    { 14, 3, 5, 0 },
    5, 5, 15 /* 10 */, 7, MST_NO_SPELLS, CE_CLEAN, Z_BIG, S_SHOUT, I_HIGH,
    MONUSE_WEAPONS_ARMOUR
}
,
...

{
    ...
    M_NO_EXP_GAIN | M_FLIES | M_RES_ELEC | M_CONFUSED | M_SPELLCASTER,
...
{
    MONS_GREATER_UNSEEN_HORROR, 'x', LIGHTCYAN, "greater unseen horror",
    M_LEVITATE | M_SEE_INVIS | M_RES_ELEC | M_INVIS,
    0, 12, MONS_GREATER_UNSEEN_HORROR, MH_NATURAL, -3,
    { 27, 0, 0, 0 },
    { 13, 3, 5, 0 },
    10, 10, 30, 7, MST_NO_SPELLS, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT, I_ANIMAL_LIKE,
    MONUSE_NOTHING
}
,

{
    MONS_VOID_GOLEM, '8', DARKGREY, "void golem",
    M_RES_POISON | M_RES_FIRE | M_RES_COLD | M_RES_ELEC | M_SEE_INVIS,
    0, 12, MONS_VOID_GOLEM, MH_NONLIVING, 5000,
    { 40, 0, 0, 0 },
    { 13, 7, 4, 0 },
    22, 3, 7, 7, MST_NO_SPELLS, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT, I_PLANT,
    MONUSE_OPEN_DOORS
...
{
    MONS_FAIRY_SNIPER, 'i', GREEN, "fairy sniper",
    M_LEVITATE | M_SEE_INVIS,
    0, 10, MONS_FAIRY_SNIPER, MH_NATURAL, -6,
    { 20, 0, 0, 0 },
    { 16, 2, 3, 0 },
    0, 20, 20, 7, MST_NO_SPELLS, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT, I_HIGH,
    MONUSE_WEAPONS_ARMOUR
}
,

{
    MONS_FAIRY_ASSASSIN, 'i', DARKGREY, "fairy assassin",
    M_LEVITATE | M_SEE_INVIS | M_RES_POISON,
    0, 10, MONS_FAIRY_ASSASSIN, MH_NATURAL, -6,
    { 20, 0, 0, 0 },
    { 16, 2, 3, 0 },
    0, 20, 30, 7, MST_NO_SPELLS, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT, I_HIGH,
    MONUSE_WEAPONS_ARMOUR
}
,

{
    MONS_FAIRY_BEAST_TAMER, 'i', BROWN, "fairy beast tamer",
    M_LEVITATE | M_SEE_INVIS | M_SPELLCASTER | M_ACTUAL_SPELLS,
    0, 10, MONS_FAIRY_BEAST_TAMER, MH_NATURAL, -6,
    { 9, 0, 0, 0 },
    { 16, 2, 3, 0 },
    0, 20, 13, 7, MST_FAIRY_BEAST_TAMER, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT, I_HIGH,
    MONUSE_WEAPONS_ARMOUR
}
,

{
    MONS_FAIRY_SWORD_DANCER, 'i', BLUE, "fairy sword dancer",
    M_LEVITATE | M_SEE_INVIS,
    0, 10, MONS_FAIRY_SWORD_DANCER, MH_NATURAL, -6,
    { 33, 0, 0, 0 },
    { 18, 3, 4, 0 },
    4, 20, 18, 7, MST_NO_SPELLS, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT, I_HIGH,
    MONUSE_WEAPONS_ARMOUR
}
,

{
    MONS_FAIRY_FIRE_STARTER, 'i', LIGHTRED, "fairy fire starter",
    M_LEVITATE | M_SEE_INVIS | M_RES_FIRE | M_SPELLCASTER | M_ACTUAL_SPELLS,
    0, 10, MONS_FAIRY_FIRE_STARTER, MH_NATURAL, -6,
    { 9, 0, 0, 0 },
    { 18, 2, 3, 0 },
    0, 20, 13, 7, MST_FAIRY_FIRE_STARTER, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT, I_HIGH,
    MONUSE_WEAPONS_ARMOUR
}
,

{
    MONS_FAIRY_SNOW_MAGE, 'i', WHITE, "fairy snow mage",
    M_LEVITATE | M_SEE_INVIS | M_RES_COLD | M_SPELLCASTER | M_ACTUAL_SPELLS,
    0, 10, MONS_FAIRY_SNOW_MAGE, MH_NATURAL, -6,
    { 9, 0, 0, 0 },
    { 18, 2, 3, 0 },
    0, 20, 13, 7, MST_FAIRY_SNOW_MAGE, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT, I_HIGH,
    MONUSE_WEAPONS_ARMOUR
}
,

{
    MONS_FAIRY_WIND_RIDER, 'i', LIGHTCYAN, "fairy wind rider",
    M_LEVITATE | M_SEE_INVIS | M_RES_ELEC | M_SPELLCASTER | M_ACTUAL_SPELLS,
    0, 10, MONS_FAIRY_WIND_RIDER, MH_NATURAL, -6,
    { 9, 0, 0, 0 },
    { 18, 2, 3, 0 },
    0, 20, 13, 7, MST_FAIRY_WIND_RIDER, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT, I_HIGH,
    MONUSE_WEAPONS_ARMOUR
}
,

{
    MONS_FAIRY_SCULPTOR, 'i', YELLOW, "fairy sculptor",
    M_LEVITATE | M_SEE_INVIS | M_SPELLCASTER | M_ACTUAL_SPELLS,
    0, 10, MONS_FAIRY_SCULPTOR, MH_NATURAL, -6,
    { 25, 0, 0, 0 },
    { 18, 2, 3, 0 },
    0, 20, 13, 7, MST_FAIRY_SCULPTOR, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT, I_HIGH,
    MONUSE_WEAPONS_ARMOUR
}
,

{
    MONS_FAIRY_RANDOMIZER, 'i', LIGHTMAGENTA, "fairy randomizer",
    M_LEVITATE | M_SEE_INVIS | M_SPELLCASTER | M_ACTUAL_SPELLS,
    0, 10, MONS_FAIRY_RANDOMIZER, MH_NATURAL, -6,
    { 12, 0, 0, 0 },
    { 21, 3, 4, 0 },
    0, 24, 13, 7, MST_FAIRY_RANDOMIZER, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT, I_HIGH,
    MONUSE_WEAPONS_ARMOUR
}
,

{
    MONS_FAIRY_TIME_TWISTER, 'i', LIGHTGREEN, "fairy time twister",
    M_LEVITATE | M_SEE_INVIS | M_SPELLCASTER | M_ACTUAL_SPELLS,
    0, 10, MONS_FAIRY_TIME_TWISTER, MH_NATURAL, -6,
    { 12, 0, 0, 0 },
    { 21, 3, 4, 0 },
    0, 24, 13, 7, MST_FAIRY_TIME_TWISTER, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT, I_HIGH,
    MONUSE_WEAPONS_ARMOUR
}
,
