...
void build_vaults(char force_vault);
...
int px, int py, char behaviour, int hitting, char allow_bands, int many_many, int passed [2]);
...
if (many_many == 42 && you[0].where_are_you == 1 | you[0].where_are_you == 2 | you[0].where_are_you == 4 | you[0].where_are_you == 5)
{
char which_v = 0;
...
if (many_many > 7 && many_many < 34 && random() % 7 == 0 && level_type == 0 && you[0].where_are_you == 0)
{
...
if (random3(18) == 0 && many_many > 7 && many_many < 33)
{
...
if (random3(3) == 0 && many_many > 2 && many_many < 33)
{
 plan_main(0);
 done_city = 1;
 goto skip_level;
...
{
do_city :
if (many_many == 42 && you[0].where_are_you == 1) build_vaults(51);
 else
if (random() % 3 == 0)
{
 city_level();
...
if (many_many >= 11 && many_many <= 33 && !(you[0].where_are_you == 1 | you[0].where_are_you == 2 | you[0].where_are_you == 4 | you[0].where_are_you == 5) && random3(15) == 0)
{
 do
 {
  bi = random3(80);
...
if (many_many < 26) which_unique = 13 + random() % 10;
if (many_many < 22) which_unique = 9 + random() % 9;
if (many_many < 17) which_unique = 6 + random() % 5;
if (many_many < 11) which_unique = 4 + random() % 4;
...
finished_monsters: if (many_many >= 28 && many_many <= 36 && level_type == 0 && you[0].where_are_you == 0)
{
 do
 {
  bi = random3(70);
...
if (many_many >= 27 && many_many <= 50 && (many_many == 33 | random() % 4 == 0) && level_type == 0 && you[0].where_are_you == 0)
{
 do
 {
  bi = random3(70);
...
if (many_many >= 25 && many_many <= 50 && (many_many == 31 | random() % 3 == 0) && level_type == 0 && you[0].where_are_you == 0)
{
 do
 {
  bi = random3(70);
...
if (count_x != 7)
{
 if ((count_x == 3 && you[0].where_are_you == 12 && level_type == 0 && many_many == you[0].branch_stairs [3]) | (count_x == 5 && you[0].where_are_you == 14 && level_type == 0 && many_many == you[0].branch_stairs [5]) | (count_x == 6 && you[0].where_are_you == 15 && level_type == 0 && many_many == you[0].branch_stairs [6]))
 {
  ...
  grd [bi] [bj] = 110 + count_x; //you[0].branch_stairs [count_x]; /* staircase to slime pits */
 }
 else
...
if (many_many == 35 && level_type == 0 && you[0].where_are_you == 0)
{
 for (bi = 1; bi < 80; bi ++)
 {
        for (bj = 1; bj < 70; bj ++)
...
if (menv [bk].m_class == 19)
{
 if (bk >= 170) menv [bk].m_class = 22;
  else if (menv [bk + 1].m_class != -1 | menv [bk + 2].m_class != -1 | menv [bk + 3].m_class != -1 | menv [bk + 4].m_class != -1) menv [bk].m_class = 22;
}
...
switch (random3(16))
{
 ...
 case 7: if (random3(2) == 0) menv [bk].m_class = 14; else menv [bk].m_class = 103;
 break; // orc sorceror
...
case 8: if (band_no > 0) menv [bk].m_class = 20;
if (band_no > 0 && random3(4) == 0 && many_many > 21) menv [bk].m_class = 102;
break; // ugly thing
case 9: if (band_no > 0) menv [bk].m_class = 73; break; // hell hound
case 10: if (band_no > 0) menv [bk].m_class = 9; break; // jackal
case 11: if (band_no > 0) menv [bk].m_class = 109;
...
break;
case 23: if (band_no > 0) menv [bk].m_class = 225 + random() % 2; break; // CYAN demon
case 24: if (band_no > 0) menv [bk].m_class = 221; break; // BROWN demon
case 25: if (band_no > 0) menv [bk].m_class = 23 + (random() % 2) * 26; break; // DARKGREY demon - either x/X
case 26: if (band_no > 0) menv [bk].m_class = 227 + random() % 2; break; // LIGHTGREY demons
...
switch (random3(13))
{
 ...
 case 12: if (random() % 4 == 0) menv [bk].m_class = 271 + random() % 4;
...
if (menv [bk].m_class >= 280 && menv [bk].m_class <= 309) you[0].unique_creatures [menv [bk].m_class - 280] = 1;
...
case 309: // Margery
case 109: if (bk < MNST - 50 && band == 0 && band_no == 0)
 {
  band = 11; // hell knight
  band_no = 4 + random3(4);
 }
...
case 363: // vamp mage
case 294: // Josephine
case 110: if (bk < MNST - 50 && band == 0 && band_no == 0)
 {
  band = 22; // necromancer
  band_no = 4 + random3(4);
 }
...
case 113: if (bk < MNST - 50 && band == 0 && band_no == 0)
 {
...
case 115: if (bk < MNST - 50 && band == 0 && band_no == 0)
 {
  band = 13; // gnoll
  band_no = 2 + random3(2);
 }
...
case 138: if (bk < MNST - 50 && band == 0 && band_no == 0)
 {
  band = 16; // bumble bees
  band_no = 2 + random3(4);
 }
...
case 2: if (bk < MNST - 50 && band == 0 && band_no == 0 && random3(3) == 0 && many_many > 9)
 {
  band = 17; // centaurs
  band_no = 2 + random3(2);
 }
...
case 133: if (bk < MNST - 50 && band == 0 && band_no == 0 && random3(2) == 0)
 {
  band = 18; // yaktaurs
  band_no = 2 + random3(2);
 }
...
case 134: if (bk < MNST - 50 && band == 0 && band_no == 0)
 {
  band = 21; // death yaks
  band_no = 2 + random3(4);
 }
...
case 140: if (bk < MNST - 50 && band == 0 && band_no == 0)
 {
  band = 19; // wisps
  band_no = 4 + random3(5);
 }
...
case 142: if (bk < MNST - 50 && band == 0 && band_no == 0)
 {
  band = 20; // ogre mage
  band_no = 4 + random3(4);
 }
...
case 233: if (bk < MNST - 50 && band == 0 && band_no == 0)
 {
...
case 234: if (bk < MNST - 50 && band == 0 && band_no == 0)
 {
...
case 230: if (bk < MNST - 50 && band == 0 && band_no == 0 && random() % 2 == 0)
 {
...
case 227: if (bk < MNST - 50 && band == 0 && band_no == 0 && random() % 2 == 0)
 {
...
case 264: if (bk < MNST - 50 && band == 0 && band_no == 0 && random() % 2 == 0)
 {
...
case 265: if (bk < MNST - 50 && band == 0 && band_no == 0 && random() % 2 == 0)
 {
...
case 270: if (bk < MNST - 50 && band == 0 && band_no == 0 && random() % 2 == 0)
 {
...
case 53: if (bk < MNST - 50 && band == 0 && band_no == 0 && random() % 2 == 0)
 {
...
case 260:
case 261: if (bk < MNST - 50 && band == 0 && band_no == 0)
 {
  band = 31; // Nagas
  band_no = 3 + random3(4);
 }
...
case 150: if (bk < MNST - 50 && band == 0 && band_no == 0)
 {
  band = 32; // war dogs
  band_no = 2 + random3(4);
 }
...
case 151: if (bk < MNST - 50 && band == 0 && band_no == 0)
 {
  band = 33; // grey rats
  band_no = 4 + random3(6);
 }
...
case 152: if (bk < MNST - 50 && band == 0 && band_no == 0)
 {
  band = 34; // green rats
  band_no = 4 + random3(6);
 }
...
case 153: if (bk < MNST - 50 && band == 0 && band_no == 0)
 {
  band = 35; // orange rats
  band_no = 3 + random3(4);
 }
...
case 155: if (bk < MNST - 50 && band == 0 && band_no == 0)
 {
  band = 36; // sheep
  band_no = 3 + random3(5);
 }
...
case 156: if (bk < MNST - 50 && band == 0 && band_no == 0)
 {
  band = 37; // ghoul
  band_no = 2 + random3(3);
 }
...
if (force_class != 250) mitm.iclass [bp] = force_class;
        ...
        {
                case 0: mitm.itype [bp] = random3(19); // weapons
...
if (allow_uniques == 1)
  {
   ...
   } else if (you[0].unique_items [24 + no_unique - 7] == 1 | (many_many == 51 && you[0].unique_items [24 + no_unique - 7] == 0) | (you[0].unique_items [24 + no_unique - 7] == 2 && many_many != 51)) goto out_of_uniques;
...
/* 23 - quick blade and 24 - katana aren't here - no specials */
          ...
          if (random() % 13 == 0) mitm.idam [bp] = (mitm.idam [bp] / 30) * 30 + 13; // vamp
  ...
  mitm.iplus [bp] = 0;
   ...
   mitm.iplus [bp] = 0;
   mitm.iplus2 [bp] = 0;
   if (random3(35) <= many_many + 10) mitm.itype [bp] = random3(5);
   if (random3(60) <= many_many + 10) mitm.itype [bp] = random3(8);
   if (20 + many_many >= random3(500) && random3(10) == 0) mitm.itype [bp] = 15 + random3(7);
   if (20 + many_many >= random3(600) && random3(20) == 0) mitm.itype [bp] = 22 + random3(8);
...
if (force_spec == 250 && random() % 2 == 0)
{
   ...
   {
                        if (50 + many_many >= random3(300) | (mitm.itype [bp] == 10 && mitm.iplus2 [bp] == 3))
   {
                         mitm.iplus [bp] += random3 (3);
 ...
 if (20 + many_many >= random3(400) && (mitm.idam [bp] != 180 | mitm.itype [bp] <= 7))
  ...
  /* skin armours + Crystal PM don't get special enchantments or species */

  break;

                case 3: //      wands
                        mitm.itype [bp] = random3 (19);
                        if (force_type != 250) mitm.itype [bp] = force_type;
  ...
  if (mitm.itype [bp] == 12 | mitm.itype [bp] == 15 | mitm.itype [bp] == 16)
      ...
      switch(pot)
      {
         ...
         if (random3(50) == 0) mitm.itype [bp] = 13; // oatmeal
         break;
         ...
         switch(random3(6))
         {
            ...
            case 5: mitm.itype [bp] = 23; break; // mutation
         }
  ...
  mitm.iplus [bp] = 0;
                ...
                if (random() % 3 == 0) mitm.itype [bp] = 35 + random() % 10;
  if (force_type != 250) mitm.itype [bp] = force_type;
                quant = 1;
  mitm.iplus [bp] = 50;
                if (mitm.itype [bp] == 1 | mitm.itype [bp] == 5 | mitm.itype [bp] == 11 | mitm.itype [bp] == 14 | mitm.itype [bp] == 15)
                {
        mitm.iplus [bp] = 50;
      ...
      if (mitm.itype [bp] == 6) // ring of slaying - not working
       mitm.itype [bp] = 7; // see invis
                break;
...
if (many_many < 23 && random3(3) != 0) spec_room_type = 3;
if (many_many < 17 && random3(3) != 0) spec_room_type = 0;
if (many_many < 10) spec_room_type = 1;
...
if (ztype == 250)
{
   ...
   } while (mons_zombie_size(menv [bk].m_sec) == 0 | mons_zombie_size(menv [bk].m_sec) == not_zombsize); // | (cs > 100 && mons_skeleton(ztype) == 0));
...
force_spec = 100;
              {
                mitm.iclass [bp] = 0;
                mitm.itype [bp] = 14;
                if (menv [bk].m_class == 133) mitm.itype [bp] = 15;
                mitm.icol [bp] = BROWN;
                iquan = 1;
              }
...
mitm.idam [bp] = 150;
if (random3(5) == 0) mitm.idam [bp] = 151;
if (random3(5) == 0) mitm.idam [bp] = 158;
if (random3(5) == 0) mitm.idam [bp] = 160;
mitm.iplus [bp] += random3(5) + 1;
mitm.iplus2 [bp] = 50 + random3(5) + 1;
mitm.icol [bp] = RED;
...
if (menv [bk].m_class == 60) mitm.icol [thing_created] = WHITE;
        ...
        if (mitm.iplus [thing_created] > 130)
         ...
         else   menv [bk].m_AC += property(mitm.iclass [thing_created], mitm.itype [thing_created], 0) + mitm.iplus [thing_created] - 50;
...
{
        if (mitm.iclass [bi] == 100 | mitm.iquant [bi] == 0 | mitm.ix [bi] == 1) continue;
...
switch(sbook_type)
{
 ...
 case 18: // book of bodily restorations
  ...
  case 19: // useful magic
       ...
       func_pass [2] = 38; // less healing
       func_pass [3] = 43; // selective amn
       func_pass [4] = 48; // detect curse
       func_pass [5] = 14; // dig
       func_pass [6] = 4; // remove curse
  break;

// 20 is no longer prayers
  case 20: // book of War Chants - if any are added here, must change Crusader in crawlfnc.cc
       func_pass [0] = 0;
       func_pass [1] = 83; // deflect missiles
       func_pass [2] = 84; // berserk
       func_pass [3] = 111; // regeneration
       func_pass [4] = 22; // haste
       func_pass [5] = 210; //
       func_pass [6] = 210; //
  break;
 ...
 case 31: // book of spatial dislocations
  ...
  case 32: // book of venom
       ...
       func_pass [2] = 36; // olg tox rad
       func_pass [3] = 142; // poison resistance
       func_pass [4] = 56; // poison cloud
       func_pass [5] = 210; //
       func_pass [6] = 210; //
  break;
...
if (env[0].sh_type [i] != 2 && env[0].sh_type [i] != 3 && env[0].sh_type [i] != 4)
 env[0].sh_greed [i] = 10 + random3(5) + random3(many_many / 2);
  else env[0].sh_greed [i] = 15 + random3(10) + random3(10) + random3(many_many);

 int plojy = 5 + random3(5) + random3(5) + random3(4);
  for (j = 0; j < plojy; j++)
  {
   if (env[0].sh_type [i] != 2 && env[0].sh_type [i] != 3 && env[0].sh_type [i] != 4)
           item_level = random() % ((many_many + 1) * 2);
            else item_level = random() % ((many_many + 1) * 3);

//   orb = items(0, 1, item_in_shop(env[0].sh_type [i]), 250, 0, item_level, 250);
    orb = items(1, item_in_shop(env[0].sh_type [i]), 250, 0, item_level, 250);    mitm.ix [orb] = 0;
    mitm.iy [orb] = 5 + i;
...
if (force_plan == 0) force_plan = random3(6) + 1;
...
switch(force_plan)
{
 ...
 case 5: if (random() % 9 != 0) do_stairs = plan_3();
...
{
if (monster_level >= 39) monster_level = 39; // makes really high level monsters (titans etc) more common here
place_monster(
250,
monster_type_thing,
1,
...
if (bi == 0) join_the_dots(vsx, vsy, romx1 [which_room], romy1 [which_room], v1x, v1y, v2x, v2y);
 else
 if (exclusive == 1)
 {
  for (cnx = romx1 [which_room] - 1; cnx < romx2 [which_room] + 1; cnx ++)
