...
int spellbook_template_array[NUMBER_SPELLBOOKS][7] =
{
  ...
  {0,
   SPELL_THROW_FROST,
   SPELL_BOLT_OF_COLD,
   SPELL_LIGHTNING_BOLT,          // Thunderbolt     // value (17) and label do not match 22jan2000 {dlb}
   SPELL_NO_SPELL,
   SPELL_NO_SPELL,
   SPELL_NO_SPELL
  },
      ...
      switch (menv[bk].type)
      {
         ...
         case MONS_VAMPIRE_KNIGHT:
            ...
            switch (random2(6))
            {
               ...
               case 4:
                  if ( coinflip() ) mitm.sub_type[bp] = WPN_GLAIVE;
                  else if ( coinflip() ) mitm.sub_type[bp] = WPN_HALBERD;
         ...
         case MONS_DAEVA:
            mitm.base_type[bp] = OBJ_WEAPONS;
            mitm.sub_type[bp] = WPN_LONG_SWORD;
            if ( one_chance_in(4) ) mitm.sub_type[bp] = WPN_GREAT_SWORD;
