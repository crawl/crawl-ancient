...
case 0:
    ...
    break;
case 1:
    buffy[bufcount + 1] = rock_colour;  //BROWN;
...
case 4:
    ...
    break;
case 5:
    showed = 177;               // hidden secret door

    buffy[bufcount + 1] = rock_colour;
    break;
case 6:
    showed = 177;
...
case 61:
    ...
    break;
case 62:
    showed = 247;               // this wavy thing also used for water elemental
...
case 67:
    buffy[bufcount + 1] = floor_colour;         //LIGHTGRAY;
...
default:
    ...
    if (mnr >= 297)
    {
        ...
        showed = show[count_x - you[0].x_pos + 9][count_y - you[0].y_pos + 9];
    break;
