...
void activate_ability( void )
{
    ...
    struct talent abil_now[80];     // see elsewhere for comments - 80 is *way* generous here {dlb}
...
// populate the array of structs {dlb}:
    ...
    for (;;)
    {
        ...
        redraw_screen();
            ...
            if ( ( unthing >= '@' && unthing <= '[' ) || ( unthing >= 'a' && unthing <= 'z' ) )
            {
                keyin = unthing;
                break;
            }
    ...
    if ( ( spc < 'a' || spc > 'y' ) && ( spc < 'A' || spc > 'Z' ) )    // shouldn't that 'y' be a 'z' ??? {dlb}
    {
...
// no turning back now... {dlb}
    ...
    switch ( abil_now[abil_used].which )
    {
      ...
      case ABIL_GLAMOUR:
        ...
        cast_glamour( 10 + random2(you.experience_level/2) + random2(you.experience_level/2) );
      ...
      case ABIL_SPIT_POISON:      // Naga + spit poison mutation
        if ( you.duration[DUR_BREATH_WEAPON] )
          canned_msg(MSG_CANNOT_DO_YET);
        else if ( spell_direction(abild, &beam[0]) == -1 )
          canned_msg(MSG_OK);
        else
        {
            mpr("You spit poison.");

            zapping(ZAP_SPIT_POISON, you.experience_level + you.mutation[MUT_SPIT_POISON] * 5, &beam[0]);
      ...
      case ABIL_BREATHE_STEAM:
        if ( you.duration[DUR_BREATH_WEAPON] && abil_now[abil_used].which != ABIL_SPIT_ACID )
        {
            canned_msg(MSG_CANNOT_DO_YET);
            return;
        }
        ...
        switch ( abil_now[abil_used].which )
        {
          case ABIL_BREATHE_FIRE:
            ...
            zapping(ZAP_BREATHE_FIRE, you.experience_level + (you.mutation[MUT_BREATHE_FLAMES] << 2) + (you.attribute[ATTR_TRANSFORMATION] ? 10 : 0), &beam[0]);
            break;
          case ABIL_BREATHE_FROST:
            mpr("You breathe a wave of freezing cold.");
            zapping(ZAP_BREATHE_FROST, you.experience_level, &beam[0]);
            break;
          case ABIL_BREATHE_POISON:
            mpr("You breathe a blast of poison gas.");
            zapping(ZAP_BREATHE_POISON, you.experience_level, &beam[0]);
            break;
          case ABIL_BREATHE_LIGHTNING:
            mpr("You spit a bolt of lightning.");
            zapping(ZAP_LIGHTNING, (you.experience_level << 1), &beam[0]);
            break;
          case ABIL_SPIT_ACID:
            mpr("You spit acid.");
            zapping(ZAP_BREATHE_ACID, you.experience_level, &beam[0]);
            break;
          case ABIL_BREATHE_POWER:
            mpr("You spit a bolt of incandescent energy.");
            zapping(ZAP_BREATHE_POWER, you.experience_level, &beam[0]);
            break;
          case ABIL_BREATHE_STICKY_FLAME:
            mpr("You spit a glob of burning liquid.");
            zapping(ZAP_STICKY_FLAME, you.experience_level, &beam[0]);
            break;
          case ABIL_BREATHE_STEAM:
            mpr("You breathe a blast of scalding steam.");
            zapping(ZAP_BREATHE_STEAM, you.experience_level, &beam[0]);
            break;
        }
        ...
        make_hungry(200 + random2avg(99,2) - (you.experience_level * random2(5)), false);
        you.turn_is_over = 1;
        break;
      ...
      case ABIL_FLY:    // fly (kenku) -- eventually becomes permanent (see acr.cc)
        if ( !enough_mp(3, false) )
          return;
      ...
      case ABIL_FLY_II:    // Fly (Draconians, or anything else with wings)
        ...
        {
            cast_fly(you.experience_level << 1);
...
// DEMONIC POWERS:
      case ABIL_SUMMON_MINOR_DEMON:
        ...
        summon_ice_beast_etc(you.experience_level << 2, summon_any_demon(DEMON_LESSER));
      ...
      case ABIL_SUMMON_DEMON:
        ...
        summon_ice_beast_etc(you.experience_level << 2, summon_any_demon(DEMON_COMMON));
      ...
      case ABIL_RAISE_DEAD:
        ...
        your_spells(SPELL_ANIMATE_DEAD, you.experience_level * 5, false);   // power (2nd number) is meaningless
      ...
      case ABIL_CONTROL_DEMON:
        ...
        zapping(ZAP_CONTROL_DEMON, you.experience_level * 5, &beam[0]);
      ...
      case ABIL_THROW_FROST:
        ...
        zapping(( abil_now[abil_used].which == ABIL_THROW_FLAME ? ZAP_FLAME : ZAP_FROST ), you.experience_level * 3, &beam[0]);
        break;
      ...
      case ABIL_BOLT_OF_DRAINING:
        ...
        zapping(ZAP_NEGATIVE_ENERGY, you.experience_level * 6, &beam[0]);
...
// INVOCATIONS:
      ...
      case ABIL_SUMMON_GUARDIAN:
        ...
        summon_ice_beast_etc(you.skills[SK_INVOCATIONS] << 2, MONS_ANGEL);
      ...
      case ABIL_SMITING:
        ...
        cast_smiting(you.skills[SK_INVOCATIONS] << 3);
      ...
      case ABIL_ANNIHILATE_UNDEAD:
        if ( !enough_mp(3, false) )
          return;
        else if (spell_direction(spd, &beam[0]) == -1)
          {
            canned_msg(MSG_OK);
            return;
          }

        zapping(ZAP_DISPEL_UNDEAD, you.skills[SK_INVOCATIONS] * 6, &beam[0]);
      ...
      case ABIL_THUNDERBOLT:
        ...
        zapping(ZAP_LIGHTNING, you.skills[SK_INVOCATIONS] * 6, &beam[0]);
      ...
      case ABIL_SUMMON_DAEVA:
        ...
        summon_ice_beast_etc(you.skills[SK_INVOCATIONS] << 2, MONS_DAEVA);
      ...
      case ABIL_ENSLAVE_UNDEAD:
        ...
        zapping(ZAP_ENSLAVE_UNDEAD, you.skills[SK_INVOCATIONS] << 3, &beam[0]);
      ...
      case ABIL_ANIMATE_DEAD:
        ...
        animate_dead(1 + you.skills[SK_INVOCATIONS], BEH_ENSLAVED, you.pet_target, 1);
      ...
      case ABIL_CONTROL_UNDEAD:
        ...
        mass_enchantment(30, you.skills[SK_INVOCATIONS] << 3);
      ...
      case ABIL_MIGHT_I:
        ...
        potion_effect(POT_MIGHT, you.skills[SK_INVOCATIONS] << 3);
      ...
      case ABIL_HASTE:
        ...
        potion_effect(POT_SPEED, you.skills[SK_INVOCATIONS] << 3);
      ...
      case ABIL_MINOR_DESTRUCTION:
        ...
        {
          case 0:
            zapping(ZAP_FLAME, power, &beam[0]);
            break;
          case 1:
            zapping(ZAP_PAIN, power, &beam[0]);
            break;
          case 2:
            zapping(ZAP_STONE_ARROW, power, &beam[0]);
            break;
          case 3:
            zapping(ZAP_ELECTRICITY, power, &beam[0]);
            break;
          case 4:
            power = power / 2;
            zapping(ZAP_BREATHE_ACID, power, &beam[0]);
            break;
        }
      ...
      case ABIL_LESSER_SERVANT_OF_MAKHLEB:
        ...
        summon_ice_beast_etc(20 + you.skills[SK_INVOCATIONS] * 3, MONS_NEQOXEC + random2(5));
      ...
      case ABIL_MAJOR_DESTRUCTION:
        ...
        {
          case 0:
            zapping(ZAP_FIRE, you.skills[SK_INVOCATIONS] * 5, &beam[0]);
            break;
          case 1:
            zapping(ZAP_FIREBALL, you.skills[SK_INVOCATIONS] * 5, &beam[0]);
            break;
          case 2:
            zapping(ZAP_LIGHTNING, you.skills[SK_INVOCATIONS] * 5, &beam[0]);
            break;
          case 3:
            zapping(ZAP_NEGATIVE_ENERGY, you.skills[SK_INVOCATIONS] * 5, &beam[0]);
            break;
          case 4:
            zapping(ZAP_STICKY_FLAME, you.skills[SK_INVOCATIONS] * 5, &beam[0]);
            break;
          case 5:
            zapping(ZAP_IRON_BOLT, you.skills[SK_INVOCATIONS] * 5, &beam[0]);
            break;
          case 6:
            zapping(ZAP_ORB_OF_ELECTRICITY, you.skills[SK_INVOCATIONS] * 5, &beam[0]);
            break;
          case 7:
      ...
      case ABIL_GREATER_SERVANT_OF_MAKHLEB:
        ...
        summon_ice_beast_etc(20 + you.skills[SK_INVOCATIONS] * 3, MONS_EXECUTIONER + random2(5));
...
//jmf: intended as invocations from evil god(s):
      case ABIL_TRAN_SERPENT_OF_HELL:
        ...
        transform(10 + (you.experience_level << 1) + (you.skills[SK_INVOCATIONS] * 3), TRAN_SERPENT_OF_HELL);
      ...
      case ABIL_BREATHE_HELLFIRE:
        if ( !enough_hp(9, false) )
          return;
        else if ( you.duration[DUR_BREATH_WEAPON] )
          {
            canned_msg(MSG_CANNOT_DO_YET);
            return;
          }
        ...
        zapping(ZAP_HELLFIRE, 20 + you.experience_level, &beam[0]);

        dec_hp(8, false);
        make_hungry(200 + random2avg(99,2) - (you.experience_level * random2(5)), false);
        you.duration[DUR_BREATH_WEAPON] += 3 + random2(5) + random2(30 - you.experience_level);
        break;
      ...
      case ABIL_ROTTING:
        ...
        cast_rotting((you.experience_level << 1) + (you.skills[SK_INVOCATIONS] * 3));
      ...
      case ABIL_SHUGGOTH_SEED:
        if ( !enough_mp(12, false) || !enough_hp(9, false) )
          return;
        else if ( you.duration[DUR_SHUGGOTH_SEED_RELOAD] )
          {
            canned_msg(MSG_CANNOT_DO_YET);
            return;
          }

        cast_shuggoth_seed(you.experience_level*2 +you.skills[SK_INVOCATIONS]*3);
      ...
      case ABIL_RENOUNCE_RELIGION:
        if ( yesno("Really renouce your faith, foregoing its fabulous benefits?") && yesno("Are you sure you won't change your mind later?") )
          excommunication();
        else
          canned_msg(MSG_OK);
        break;
...
// Invocations:
                  ...
                  case ABIL_GREATER_HEALING:
                    ...
                    break;
/* ******************************************************************
// jmf never integrated this {dlb}:
                  case ABIL_SUMMON_SERPENTS:
                    cprintf("Summon Serpents                 3 Magic, Food, Piety");
                    break;
****************************************************************** */
                  case ABIL_TRAN_SERPENT_OF_HELL:
                    cprintf("Turn into Demonic Serpent      16 Magic, Food, Piety");
                    break;
                  case ABIL_ROTTING:
...
// checking for species-related abilities and mutagenic counterparts {dlb}:
    ...
    {
        if ( you.experience_level > 4 && you.attribute[ATTR_TRANSFORMATION] == TRAN_NONE )
    ...
    {
        if ( !you.mutation[MUT_BREATHE_POISON] )    //jmf: "upgrade" from Lsha
...
// checking for draconian-only abilities and non-draconian counterparts {dlb}:
    if ( player_genus(GENPC_DRACONIAN) )
    {
        if ( you.experience_level > 6 )
        {

            ability = ( (you.species == SP_GREEN_DRACONIAN )   ? ABIL_BREATHE_POISON :
    ...
    {
        if ( you.attribute[ATTR_TRANSFORMATION] == TRAN_DRAGON || you.mutation[MUT_BREATHE_FLAMES] )
...
// transformation-only powers {dlb}:
    ...
    if ( you.attribute[ATTR_TRANSFORMATION] == TRAN_SERPENT_OF_HELL )    //jmf: breathe hellfire when transformed
...
// always changing around
    ...
    else if ( ( you.equip[EQ_LEFT_RING] != -1 && you.inv_type[you.equip[EQ_LEFT_RING]] == RING_INVISIBILITY )
                 || ( you.equip[EQ_RIGHT_RING] != -1 && you.inv_type[you.equip[EQ_RIGHT_RING]] == RING_INVISIBILITY )
                 || ( you.equip[EQ_CLOAK] != -1 && you.inv_dam[you.equip[EQ_CLOAK]] % 30 == SPARM_DARKNESS )
                 || ( you.equip[EQ_HELMET] != -1 && you.inv_dam[you.equip[EQ_HELMET]] % 30 == SPARM_DARKNESS )
    ...
    else if ( ( you.equip[EQ_LEFT_RING] != -1 && you.inv_type[you.equip[EQ_LEFT_RING]] == RING_LEVITATION )
                 || ( you.equip[EQ_RIGHT_RING] != -1 && you.inv_type[you.equip[EQ_RIGHT_RING]] == RING_LEVITATION )
                 || ( you.equip[EQ_BOOTS] != -1 && you.inv_dam[you.equip[EQ_BOOTS]] % 30 == SPARM_LEVITATION )
    ...
    if ( ( you.equip[EQ_LEFT_RING] != -1 && you.inv_type[you.equip[EQ_LEFT_RING]] == RING_TELEPORTATION )
            || ( you.equip[EQ_RIGHT_RING] != -1 && you.inv_type[you.equip[EQ_RIGHT_RING]] == RING_TELEPORTATION )
            || you.mutation[MUT_TELEPORT_AT_WILL]
            || scan_randarts(RAP_CAN_TELEPORT) )
      insert_ability(ABIL_TELEPORTATION, &p_abils);

// God takes abilities taken away until penance completed
    p_abils = (zeroindex + 26);     // look at output routine for why this is done {dlb}
...
static bool insert_ability( int which_ability, struct talent * *p_pabils )
{
    ...
    // begin species abilities - some are mutagenic, too {dlb}
#ifdef USE_ELVISH_GLAMOUR_ABILITY
        case ABIL_GLAMOUR:
          failure = 50 - (you.experience_level << 1);
          break;
#endif
        case ABIL_SPIT_POISON:
          failure = (you.species == SP_NAGA) ? 20 - you.experience_level
                                             : 30 - (10 * you.mutation[MUT_SPIT_POISON] + you.experience_level);
          break;
        ...
        case ABIL_BREATHE_FIRE:
          failure = (you.species == SP_RED_DRACONIAN) ? 30 - you.experience_level
                                                      : 50 - (10 * you.mutation[MUT_BREATHE_FLAMES] + you.experience_level);
    ...
    // begin demonic powers {dlb}
        ...
        case ABIL_SUMMON_DEMON:
          ...
          break;
        case ABIL_TO_PANDEMONIUM:
          failure = 57 - (you.experience_level << 1);
          break;
        case ABIL_HELLFIRE:
        case ABIL_RAISE_DEAD:
    ...
    // begin item abilities - some possibly mutagenic {dlb}
        ...
        case ABIL_GO_BERSERK_I:
          ...
          if ( player_genus(GENPC_DWARVEN) || you.species == SP_HILL_ORC || you.species == SP_OGRE )
            failure -= 10;
    ...
    // begin invocations {dlb}
        ...
        case ABIL_RECALL_UNDEAD:
          invoc = true;
          failure = 50 - (you.piety / 10) - (you.skills[SK_INVOCATIONS] << 2);
          break;
        case ABIL_PESTILENCE:
        case ABIL_ANNIHILATE_UNDEAD:
          invoc = true;
        ...
        case ABIL_DRAIN_LIFE:
          invoc = true;
          failure = 60 - (you.piety / 15) - (you.skills[SK_INVOCATIONS] << 2);
          break;
        case ABIL_HOLY_WORD:
        case ABIL_THUNDERBOLT:
        case ABIL_HASTE_SELF:
        ...
        case ABIL_GREATER_SERVANT_OF_MAKHLEB:
          invoc = true;
          failure = 70 - (you.piety / 15) - (you.skills[SK_INVOCATIONS] << 2);
          break;
        case ABIL_SUMMON_GUARDIAN:
        case ABIL_SUMMON_DAEVA:
        case ABIL_INVOKE_DEATH:
        case ABIL_GREATER_HEALING:
          invoc = true;
          failure = 80 - (you.piety / 15) - (you.skills[SK_INVOCATIONS] << 2);
          break;
        case ABIL_RENOUNCE_RELIGION:
          invoc = true;
          failure = 0;
...
/* NO TIE-IN TO THESE AT ALL in the code */
