...
protected:
        struct SCell {
                ...
                RGBColor                color;
                        ...
                        SCell()         {ch = ' '; color.red = color.green = color.blue = 65535;}
        };
                ...
                case kFileMenu:
                        if (item == 1)
                                ...
                                if (answer == kSaveChanges)
                                        ch = 'S';                                               // $$$ this only works if the game is underway...
...
void CWindow::DoWritePrefs()
{
        ...
        Point loc = {48, 16};                                   // window position
