       ...
       if (grd [beam[0].bx + beam[0].move_x] [beam[0].by + beam[0].move_y] > 10)
{
   ...
   beam[0].aim_down = 0;
                ...
                {
                        if (grd [beam[0].bx] [beam[0].by + beam[0].move_y] > 10 && grd [beam[0].bx + beam[0].move_x] [beam[0].by] > 10)
                        {
                                beam_sign_x *= -1; beam_sign_y *= -1;
                        }
                        if (grd [beam[0].bx + beam[0].move_x] [beam[0].by] <= 10 && grd [beam[0].bx] [beam[0].by + beam[0].move_y] > 10)
                        {
                                beam_sign_x *= -1;
                        }
                        if (grd [beam[0].bx] [beam[0].by + beam[0].move_y] <= 10 && grd [beam[0].bx + beam[0].move_x] [beam[0].by] > 10)
                        ...
                        if ((grd [beam[0].bx] [beam[0].by + beam[0].move_y] <= 10 && grd [beam[0].bx + beam[0].move_x] [beam[0].by] <= 10))// | (grd [beam[0].bx] [beam[0].by + beam[0].move_y] > 10 && grd [beam[0].bx + beam[0].move_x] [beam[0].by]))
                        {
                                beam_sign_x *= -1; beam_sign_y *= -1;
                        }
...
//   naughty(8, 5);
                ...
                } else if ((beam[0].thing_thrown == 1 | beam[0].thing_thrown == 3) && mons_near(o) == 1) print_wounds(o);
...
landed : if (beam[0].bx == beam[0].target_x && beam[0].by == beam[0].target_y && beam[0].aim_down == 1)
// had if beam == tracer
{
        beam[0].aim_down = 0;
        return;
