...
{
    if (see_grid(beam[0].bx, beam[0].by) == 1 || (you.x_pos == beam[0].bx && you.y_pos == beam[0].by))
...
//1 = fire, 3 = cold, 2 = stinking
                ...
                if ((env.cloud_type[clouty] == 3 && beam[0].flavour == 2) || (env.cloud_type[clouty] == 1 && beam[0].flavour == 3))
                {
                    if (see_grid(beam[0].bx, beam[0].by) == 1)
                    {
            ...
            if (mgrd[beam[0].bx][beam[0].by] != MNG)
            {
                if (beam[0].beam_name[0] != 48)
                {
                    ...
                    if (menv[o].type >= MLAVA0 && menv[o].number == 1)
                        continue;
                    ...
                    if (menv[o].hit_points <= 0)
                    {
                        ...
                        {
                        case 1:
                            monster_die(o, 3, beam[0].beam_source);
                        ...
                        case 2:
                            monster_die(o, 4, beam[0].beam_source);
