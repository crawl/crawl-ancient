...
*/
void losight(unsigned int sh[19][19], unsigned char gr[GXM][GYM], int x_p,
             int y_p)
{
    ...
    //bool behind = false;
    // variable meaningless in usage (check below) {dlb}
    ...
    for (shad = 1; shad < 5; shad++)
    {
        ...
        see_section = !(gr[x_p + xs][y_p + ys] < MINSEE
                            && gr[x_p + xs][y_p] < MINSEE);

        see = see_section;

        sh[startPoint_x][startPoint_y]
            = ((see) ? gr[x_p + startPoint_x - 9][y_p + startPoint_y - 9] : 0);

        if (see && gr[x_p + startPoint_x - 9][y_p + startPoint_y - 9] < MINSEE)
            see = false;

        sh[startPoint_x + xs][startPoint_y + ys]
            = ((see) ? gr[x_p + startPoint_x + xs - 9]
                       [y_p + startPoint_y + ys - 9] : 0);

        if (see && gr[x_p + startPoint_x + xs - 9]
                     [y_p + startPoint_y + ys - 9] < MINSEE)
        {
            see = false;
        }

        sh[startPoint_x + xsmult[1]][startPoint_y + ysmult[1]]
            = ((see) ? gr[x_p + startPoint_x + xsmult[1] - 9]
                         [y_p + startPoint_y + ysmult[1] - 9] : 0);

        if (see && gr[x_p + startPoint_x + xsmult[1] - 9]
                     [y_p + startPoint_y + ysmult[1] - 9] < MINSEE)
        {
            see = false;
        }

        sh[startPoint_x + xsmult[2]][startPoint_y + ysmult[2]]
            = ((see) ? gr[x_p + startPoint_x + xsmult[2] - 9]
                         [y_p + startPoint_y + ysmult[2] - 9] : 0);

        sh[startPoint_x + xsmult[2]][startPoint_y + ysmult[1]] =
            ((see) ? gr[x_p + startPoint_x + xsmult[2] - 9]
                       [y_p + startPoint_y + ysmult[1] - 9] : 0);

// Wider:

        // This is done in a different way: see the >= MINSEE
        // instead of < MINSEE

        if (gr[x_p + startPoint_x + xsmult[2] - 9]
              [y_p + startPoint_y + ysmult[2] - 9] >= MINSEE)     //see = false;
        {
            if (see)
            {
                sh[startPoint_x + xsmult[3]][startPoint_y + ysmult[3]]
                    = gr[x_p + startPoint_x + xsmult[3] - 9]
                        [y_p + startPoint_y + ysmult[3] - 9];
            }
            else
            {
...
// That's one line done...
        ...
        if (gr[x_p + xs][y_p + ys] < MINSEE && gr[x_p + xs][y_p] < MINSEE
            || gr[x_p + xsmult[1]][y_p + ys] < MINSEE
            && gr[x_p + xsmult[1]][y_p] < MINSEE)
        {
            see_section = false;
        }
        ...
        sh[startPoint_x + xs][startPoint_y]
            = ((see) ? gr[x_p + startPoint_x + xs - 9]
                         [y_p + startPoint_y - 9] : 0);

        if (see && gr[x_p + startPoint_x + xs - 9]
                     [y_p + startPoint_y - 9] < MINSEE)
        {
            see = false;
        }
        ...
        if (see && gr[x_p + startPoint_x + xsmult[1] - 9]
                     [y_p + startPoint_y - 9] >= MINSEE)
        {
            sh[startPoint_x + xsmult[2]][startPoint_y + ys]
                = gr[x_p + startPoint_x + xsmult[2] - 9]
                    [y_p + startPoint_y + ys - 9];

            // Wider:
            if (gr[x_p + startPoint_x + xsmult[2] - 9]
                  [y_p + startPoint_y - 9] >= MINSEE)
            {
                sh[startPoint_x + xsmult[3]][startPoint_y + ys]
                    = gr[x_p + startPoint_x + xsmult[3] - 9]
                        [y_p + startPoint_y + ys - 9];
        ...
        sh[startPoint_x + xsmult[1]][startPoint_y + ys]
            = ((see) ? gr[x_p + startPoint_x + xsmult[1] - 9]
                         [y_p + startPoint_y + ys - 9] : 0);
        ...
        // Wider:
        if (gr[x_p + startPoint_x + xsmult[2] - 9]
              [y_p + startPoint_y + ysmult[1] - 9] >= MINSEE)   //see = false;
        {
            sh[startPoint_x + xsmult[3]][startPoint_y + ysmult[2]]
                = ((see) ? gr[x_p + startPoint_x + xsmult[3] - 9]
                             [y_p + startPoint_y + ysmult[2] - 9] : 0);
        }
        else
        ...
        if (gr[x_p + startPoint_x + xsmult[2] - 9]
              [y_p + startPoint_y + ys - 9] >= MINSEE)    //see = false;
        {
            if (see)
            {
                sh[startPoint_x + xsmult[3]][startPoint_y + ysmult[1]]
                    = gr[x_p + startPoint_x + xsmult[3] - 9]
                        [y_p + startPoint_y + ysmult[1] - 9];
            }
            else
            {
        ...
        if (see_section && gr[x_p + xsmult[2]][y_p] < MINSEE
            && gr[x_p + xsmult[2]][y_p + ys] < MINSEE)
        {
            see_section = false;
        }
        ...
        if (see_section && gr[x_p + xsmult[2]][y_p + ys] < MINSEE
                        && gr[x_p + xsmult[2]][y_p + ysmult[1]] < MINSEE)
        {
            see_section = false;
        }
        ...
        sh[startPoint_x + xsmult[1]][startPoint_y]
            = ((see) ? gr[x_p + startPoint_x + xsmult[1] - 9]
                         [y_p + startPoint_y - 9] : 0);

        if (see && gr[x_p + xsmult[3]][y_p + ysmult[1]] < MINSEE
                && gr[x_p + xsmult[3]][y_p + ys] < MINSEE)
        {
            see = false;
        }
        ...
        {
            sh[startPoint_x + xsmult[1]][startPoint_y] =
                gr[x_p + startPoint_x + xsmult[1] - 9][y_p + startPoint_y - 9];
        }
        ...
        {
            sh[startPoint_x + xsmult[2]][startPoint_y] =
                gr[x_p + startPoint_x + xsmult[2] - 9][y_p + startPoint_y - 9];

            if (gr[x_p + xsmult[4]][y_p] < MINSEE
                && gr[x_p + xsmult[4]][y_p + ys] < MINSEE)
            {
                sh[startPoint_x + xsmult[3]][startPoint_y] = 0;
            }
            else
            {
                sh[startPoint_x + xsmult[3]][startPoint_y] =
                    gr[x_p + startPoint_x + xsmult[3] - 9][y_p + startPoint_y - 9];
            }
        }
        ...
        if (sh[startPoint_x + xsmult[3]][startPoint_y + ysmult[2]] != 0)
        //see = false;
        {
            if (!(gr[x_p + startPoint_x + xsmult[3] - 9]
                    [y_p + startPoint_y + ysmult[2] - 9] < MINSEE))
                    //see = false;
            {
                if (!(gr[x_p + startPoint_x + xsmult[2] - 9]
                        [y_p + startPoint_y + ysmult[2] - 9] < MINSEE))
                        //see = false;
                {
                    sh[startPoint_x + xsmult[4]][startPoint_y + ysmult[3]]
                        = ((see) ? gr[x_p + startPoint_x + xsmult[4] - 9]
                                     [y_p + startPoint_y + ysmult[3] - 9] : 0);
                {
                else
        ...
        if (sh[startPoint_x + xsmult[3]][startPoint_y + ysmult[1]] != 0)
        //see = false;
        {
            if (!(gr[x_p + startPoint_x + xsmult[3] - 9]
                    [y_p + startPoint_y + ysmult[1] - 9] < MINSEE))
                    //see = false;
            {
                if (!(gr[x_p + startPoint_x + xsmult[2] - 9]
                        ...
                        //see = false;
                {
                    sh[startPoint_x + xsmult[4]][startPoint_y + ysmult[2]]
                        = ((see) ? gr[x_p + startPoint_x + xsmult[4] - 9]
                                     [y_p + startPoint_y + ysmult[2] - 9] : 0);
                }
                else
        ...
        if (sh[startPoint_x + xsmult[3]][startPoint_y + ys] != 0)
        //see = false;
        {
            if (!(gr[x_p + startPoint_x + xsmult[3] - 9]
                    [y_p + startPoint_y + ys - 9] < MINSEE))
                    //see = false;
            {
                if (!(gr[x_p + startPoint_x + xsmult[2] - 9]
                        ...
                        //see = false;
                {
                    sh[startPoint_x + xsmult[4]][startPoint_y + ysmult[1]]
                        = ((see) ? gr[x_p + startPoint_x + xsmult[4] - 9]
                                     [y_p + startPoint_y + ysmult[1] - 9] : 0);
                }
                else
        ...
        {
            if (!(gr[x_p + startPoint_x + xsmult[3] - 9]
                    [y_p + startPoint_y - 9] < MINSEE))    //see = false;
            {
                if (!(gr[x_p + startPoint_x + xsmult[2] - 9]
                        [y_p + startPoint_y - 9] < MINSEE))     //see = false;
                {
                    sh[startPoint_x + xsmult[4]][startPoint_y + ys]
                        = ((see) ? gr[x_p + startPoint_x + xsmult[4] - 9]
                                     [y_p + startPoint_y + ys - 9] : 0);
                }
                else
        ...
        //see = false;
        {
                    ...
                    //see = false;
            {
                if (!(gr[x_p + startPoint_x + xsmult[2] - 9]
                     [y_p + startPoint_y - ys - 9] < MINSEE))   //see = false;
                {
                    sh[startPoint_x + xsmult[4]][startPoint_y]
                        = ((see) ? gr[x_p + startPoint_x + xsmult[4] - 9]
                                     [y_p + startPoint_y - 9] : 0);
                }
                else
        ...
        {
            if (!(gr[x_p + startPoint_x + xsmult[4] - 9]
                    [y_p + startPoint_y - 9] < MINSEE))    //see = false;
            {
                if (!(gr[x_p + startPoint_x + xsmult[3] - 9]
                        [y_p + startPoint_y - 9] < MINSEE))     //see = false;
                {
                    sh[startPoint_x + xsmult[5]][startPoint_y + ys]
                        = ((see) ? gr[x_p + startPoint_x + xsmult[5] - 9]
                                     [y_p + startPoint_y + ys - 9] : 0);
                }
                else
        ...
        if (sh[startPoint_x + xsmult[4]][startPoint_y - ys] != 0)
        //see = false;
        {
            if (!(gr[x_p + startPoint_x + xsmult[4] - 9]
                 [y_p + startPoint_y - ys - 9] < MINSEE))       //see = false;
            {
                if (!(gr[x_p + startPoint_x + xsmult[3] - 9]
                        ...
                        //see = false;
                {
                    sh[startPoint_x + xsmult[5]][startPoint_y]
                        = ((see) ? gr[x_p + startPoint_x + xsmult[5] - 9]
                                     [y_p + startPoint_y - 9] : 0);
                }
                else
    ...
    for (shad = 1; shad < 5; shad++)
    {
        ...
        sh[startPoint_x + xsmult[1]][startPoint_y + ysmult[2]]
            = ((see) ? gr[x_p + startPoint_x + xsmult[1] - 9]
                         [y_p + startPoint_y + ysmult[2] - 9] : 0);
...
// That's one line done...
        ...
        if (see_section
            && (gr[x_p + xs][y_p + ys] < MINSEE
                && gr[x_p][y_p + ys] < MINSEE
                || gr[x_p + xs][y_p + ysmult[1]] < MINSEE
                && gr[x_p][y_p + ysmult[1]] < MINSEE))
        {
            see_section = false;
        }
        ...
        sh[startPoint_x][startPoint_y + ys]
            = ((see) ? gr[x_p + startPoint_x - 9]
                         [y_p + startPoint_y + ys - 9] : 0);

        if (see && gr[x_p + startPoint_x - 9]
                     [y_p + startPoint_y + ys - 9] < MINSEE)
        {
            see = false;
        }
        ...
        if (see && gr[x_p + startPoint_x - 9]
                     [y_p + startPoint_y + ysmult[1] - 9] >= MINSEE)
        {
            sh[startPoint_x + xs][startPoint_y + ysmult[2]]
                = gr[x_p + startPoint_x + xs - 9]
                    [y_p + startPoint_y + ysmult[2] - 9];

            // Wider:
            if (gr[x_p + startPoint_x - 9]
                  [y_p + startPoint_y + ysmult[2] - 9] >= MINSEE)
            {
                sh[startPoint_x + xs][startPoint_y + ysmult[3]]
                    = gr[x_p + startPoint_x + xs - 9]
                        [y_p + startPoint_y + ysmult[3] - 9];
                //else sh [startPoint_x + 4*xs] [startPoint_y + ys] = 0;
            }
        ...
        sh[startPoint_x + xs][startPoint_y + ysmult[1]]
            = ((see) ? gr[x_p + startPoint_x + xs - 9]
                         [y_p + startPoint_y + ysmult[1] - 9] : 0);
        ...
        if (gr[x_p + startPoint_x + xsmult[1] - 9]
              [y_p + startPoint_y + ysmult[2] - 9] >= MINSEE)   //see = false;
        {
            sh[startPoint_x + xsmult[2]][startPoint_y + ysmult[3]]
                = ((see) ? gr[x_p + startPoint_x + xsmult[2] - 9]
                             [y_p + startPoint_y + ysmult[3] - 9] : 0);
        }
        else
        ...
        if (gr[x_p + startPoint_x + xsmult[1] - 9]
            ...
            || gr[x_p + startPoint_x + xs - 9]
                 [y_p + startPoint_y + ysmult[2] - 9] >= MINSEE) //see = false;
        {
            sh[startPoint_x + xsmult[1]][startPoint_y + ysmult[3]]
                = ((see) ? gr[x_p + startPoint_x + xsmult[1] - 9]
                             [y_p + startPoint_y + ysmult[3] - 9] : 0);
        }
        else
...
// And one more for this section:
        ...
        if (see_section && gr[x_p][y_p + ysmult[2]] < MINSEE
            && gr[x_p + xs][y_p + ysmult[2]] < MINSEE)
        {
            see_section = false;
        }
        ...
        sh[startPoint_x][startPoint_y + ysmult[1]]
            = ((see) ? gr[x_p + startPoint_x - 9]
                         [y_p + startPoint_y + ysmult[1] - 9] : 0);
        ...
        if (see_section && gr[x_p + xs][y_p + ysmult[2]] < MINSEE
            && gr[x_p + xsmult[1]][y_p + ysmult[2]] < MINSEE)
        {
            see_section = false;
        }
        ...
        if (see && gr[x_p + xsmult[1]][y_p + ysmult[3]] < MINSEE
            && gr[x_p + xs][y_p + ysmult[3]] < MINSEE)
        {
            see = false;
        }

        if ((gr[x_p][y_p + ys] < MINSEE && gr[x_p + xs][y_p + ys] < MINSEE)
            || (gr[x_p][y_p + ysmult[1]] < MINSEE
                && gr[x_p + xs][y_p + ysmult[1]] < MINSEE)
            || (gr[x_p][y_p + ysmult[2]] < MINSEE
                && gr[x_p + xs][y_p + ysmult[2]] < MINSEE))
        {
        ...
        {
            sh[startPoint_x][startPoint_y + ysmult[2]]
                    = gr[x_p + startPoint_x - 9]
                        [y_p + startPoint_y + ysmult[2] - 9];

            if (gr[x_p][y_p + ysmult[4]] < MINSEE
                && gr[x_p][y_p + ysmult[4]] < MINSEE)
            {
                sh[startPoint_x][startPoint_y + ysmult[3]] = 0;
            }
            else
            {
                sh[startPoint_x][startPoint_y + ysmult[3]]
                        = gr[x_p + startPoint_x - 9]
                            [y_p + startPoint_y + ysmult[3] - 9];
            }
        }
        ...
        //see = false;
        if (sh[startPoint_x + xsmult[2]][startPoint_y + ysmult[3]] != 0)
        {
            if (!(gr[x_p + startPoint_x + xsmult[2] - 9]
                    [y_p + startPoint_y + ysmult[3] - 9] < MINSEE))
                    //see = false;
            {
                if (!(gr[x_p + startPoint_x + xsmult[2] - 9]
                        [y_p + startPoint_y + ysmult[2] - 9] < MINSEE))
                     //see = false;
                {
                    sh[startPoint_x + xsmult[3]][startPoint_y + ysmult[4]]
                        = ((see) ? gr[x_p + startPoint_x + xsmult[3] - 9]
                                     [y_p + startPoint_y + ysmult[4] - 9] : 0);
                }
                else
        ...
        if (sh[startPoint_x + xsmult[1]][startPoint_y + ysmult[3]] != 0)
        //see = false;
        {
            if (!(gr[x_p + startPoint_x + xsmult[1] - 9]
                    [y_p + startPoint_y + ysmult[3] - 9] < MINSEE))
                    //see = false;
            {
                if (!(gr[x_p + startPoint_x + xsmult[1] - 9]
                        ...
                        //see = false;
                {
                    sh[startPoint_x + xsmult[2]][startPoint_y + ysmult[4]]
                        = ((see) ? gr[x_p + startPoint_x + xsmult[2] - 9]
                                     [y_p + startPoint_y + ysmult[4] - 9] : 0);
                }
                else
        ...
        if (sh[startPoint_x + xs][startPoint_y + ysmult[3]] != 0)
        //see = false;
        {
            if (!(gr[x_p + startPoint_x + xs - 9]
                    [y_p + startPoint_y + ysmult[3] - 9] < MINSEE))
                    //see = false;
            {
                if (!(gr[x_p + startPoint_x + xs - 9]
                        ...
                        //see = false;
                {
                    sh[startPoint_x + xsmult[1]][startPoint_y + ysmult[4]]
                        = ((see) ? gr[x_p + startPoint_x + xsmult[1] - 9]
                                     [y_p + startPoint_y + ysmult[4] - 9] : 0);
                }
                else
        ...
        if (sh[startPoint_x][startPoint_y + ysmult[3]] != 0)    //see = false;
        {
                    ...
                    //see = false;
            {
                if (!(gr[x_p + startPoint_x - 9]
                        ...
                        //see = false;
                {
                    sh[startPoint_x + xs][startPoint_y + ysmult[4]]
                        = ((see) ? gr[x_p + startPoint_x + xs - 9]
                                     [y_p + startPoint_y + ysmult[4] - 9] : 0);
                }
                else
        ...
        //see = false;
        {
                    ...
                    //see = false;
            {
                if (!(gr[x_p + startPoint_x - xs - 9]
                        ...
                        //see = false;
                {
                    sh[startPoint_x][startPoint_y + ysmult[4]]
                        = ((see) ? gr[x_p + startPoint_x - 9]
                                     [y_p + startPoint_y + ysmult[4] - 9] : 0);
                }
                else
        ...
        {
            if (!(gr[x_p + startPoint_x - 9]
                    [y_p + startPoint_y + ysmult[4] - 9] < MINSEE))
                    //see = false;
            {
                if (!(gr[x_p + startPoint_x - 9]
                        [y_p + startPoint_y + ysmult[3] - 9] < MINSEE))
                        //see = false;
                {
                    sh[startPoint_x + xs][startPoint_y + ysmult[5]]
                        = gr[x_p + startPoint_x + xs - 9]
                            [y_p + startPoint_y + ysmult[5] - 9];
        ...
        if (sh[startPoint_x - xs][startPoint_y + ysmult[4]] != 0)
        //see = false;
        {
            if (!(gr[x_p + startPoint_x - xs - 9]
                    [y_p + startPoint_y + ysmult[4] - 9] < MINSEE))
                    //see = false;
            {
                if (!(gr[x_p + startPoint_x - xs - 9]
                        ...
                        //see = false;
                {
                    sh[startPoint_x][startPoint_y + ysmult[5]]
                        = gr[x_p + startPoint_x - 9]
                            [y_p + startPoint_y + ysmult[5] - 9];
