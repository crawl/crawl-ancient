...
static FixedVector<int, NUM_MONSTERS> mon_entry; //jmf: moved from inside function

FixedVector<unsigned char, 1000> mcolour; // really important extern -- screen redraws suck w/o it {dlb}
