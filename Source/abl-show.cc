...
void activate_ability( void )
{
  ...
  FixedVector<talent, 80> abil_now;     // see elsewhere for comments - 80 is *way* generous here {dlb}
  ...
  switch ( abil_now[abil_used].which )
    ...
    case ABIL_MAJOR_DESTRUCTION:
      ...
      switch (random2(8))
        ...
        case 7:
          ...
          beam[0].beam_source = NON_MONSTER;
    ...
    case ABIL_CHARM_SNAKE:
      if ( !enough_mp(6, false) )          return;

      cast_snake_charm( you.experience_level*2 + you.skills[SK_INVOCATIONS]*3);
      ...
      if ( p_abils->which != -1 )
        {
          ...
          switch ( p_abils->which )
            ...
            case ABIL_GREATER_HEALING:
              ...
              break;
            case ABIL_CHARM_SNAKE:
              cprintf("Charm Snake                     6 Magic, Food, Piety");
            case ABIL_TRAN_SERPENT_OF_HELL:
...
static bool generate_abilities( struct talent *p_abils )
{
  ...
  // Gods take abilities taken away until penance completed
