...
int give_first_conjuration_book()
{
    ...
    if (you.skills[SK_FIRE_MAGIC] > 1) // for established spellcasters
        skill = SK_FIRE_MAGIC;
    if (you.skills[SK_ICE_MAGIC] > 1 && you.skills[SK_ICE_MAGIC] > you.skills[skill])
        skill = SK_ICE_MAGIC;
    if (you.skills[SK_AIR_MAGIC] > 1 && you.skills[SK_AIR_MAGIC] > you.skills[skill])
        skill = SK_AIR_MAGIC;
    if (you.skills[SK_EARTH_MAGIC] > 1 && you.skills[SK_EARTH_MAGIC] > you.skills[skill])
