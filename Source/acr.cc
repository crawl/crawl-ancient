...
static void open_door( char move_x, char move_y )
{
    ...
    if ( move_x != 100 )
    {
        if ( mgrd[you.x_pos + door_move[0].move_x][you.y_pos + door_move[0].move_y] != NON_MONSTER
        ...
        {
            if ( env.cgrid[you.x_pos + door_move[0].move_x][you.y_pos + door_move[0].move_y] != EMPTY_CLOUD )
              {
...
static void close_door( char door_x, char door_y )
{
    ...
    if (grd[you.x_pos + door_move[0].move_x][you.y_pos + door_move[0].move_y] == DNGN_OPEN_DOOR)
    {
        ...
        if (igrd[you.x_pos + door_move[0].move_x][you.y_pos + door_move[0].move_y] != NON_ITEM)
        {
...
static void move_player( char move_x, char move_y )
{
    ...
    if ( mgrd[you.x_pos + move_x][you.y_pos + move_y] != NON_MONSTER )
    {
